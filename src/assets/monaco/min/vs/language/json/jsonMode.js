 ...
 *-----------------------------------------------------------------------------*/
define("vs/language/json/workerManager", ["require", "exports"], function(
  e,
  t
) {
  "use strict";
  ...
  (function(e) {
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }),
      ...
      ((o = r = t.Range || (t.Range = {})).create = function(e, t, n, r) {
        if (K.number(e) && K.number(t) && K.number(n) && K.number(r))
      ...
      (o.is = function(e) {
        var t = e;
        return K.defined(t) && a.is(t.start) && a.is(t.end);
      }),
      ...
      ((c = u = t.Diagnostic || (t.Diagnostic = {})).create = function(
        ...
        return (
          K.defined(n) && (i.severity = n),
          K.defined(r) && (i.code = r),
          K.defined(o) && (i.source = o),
          i
        );
      }),
      (c.is = function(e) {
      ...
      ((l = f = t.Command || (t.Command = {})).create = function(e, t) {
        ...
        return K.defined(n) && 0 < n.length && (o.arguments = n), o;
      }),
      (l.is = function(e) {
        var t = e;
        return K.defined(t) && K.string(t.title) && K.string(t.title);
      }),
      ((g = d = t.TextEdit || (t.TextEdit = {})).replace = function(e, t) {
      ...
      ((h = t.TextDocumentEdit || (t.TextDocumentEdit = {})).create = function(
        e,
        t
      ) {
      ...
      w = (function() {
        ...
        return (
          (e.prototype.insert = function(e, t) {
            this.edits.push(d.insert(e, t));
          }),
          (e.prototype.replace = function(e, t) {
            this.edits.push(d.replace(e, t));
          }),
          (e.prototype.delete = function(e) {
            this.edits.push(d.del(e));
          }),
    ...
    (t.WorkspaceChange = x),
      ...
      (b.Markdown = "markdown"),
      ((k = t.CompletionItemKind || (t.CompletionItemKind = {})).Text = 1),
      (k.Method = 2),
      (k.Function = 3),
      (k.Constructor = 4),
      (k.Field = 5),
      ...
      ((E = t.SymbolKind || (t.SymbolKind = {})).File = 1),
      (E.Module = 2),
      (E.Namespace = 3),
      (E.Package = 4),
      (E.Class = 5),
      ...
      (T.is = function(e) {
        var t = e;
        return K.defined(t) && K.typedArray(t.diagnostics, u.is);
      }),
      ...
      (S.is = function(e) {
        ...
        return (
          K.defined(t) &&
          r.is(t.range) &&
          (K.undefined(t.command) || f.is(t.command))
        );
      }),
      ((O =
    ...
    var A,
      ...
      j = function() {};
    (t.DocumentLink = j),
      ((A = j = t.DocumentLink || (t.DocumentLink = {})).create = function(
        e,
        t
      ) {
      ...
      (t.DocumentLink = j),
      (t.EOL = ["\n", "\r\n", "\r"]),
      ((I = t.TextDocument || (t.TextDocument = {})).create = function(
        e,
        t,
        n,
        r
  ...
  define("vs/language/json/languageFeatures", [
    "require",
    "exports",
    ...
    var r = monaco.Uri,
      ...
      o = (function() {
        function e(e, t) {
          ...
          this._disposables.push(monaco.editor.onDidCreateModel(n)),
            ...
            this._disposables.push(
              monaco.editor.onDidChangeModelLanguage(function(e) {
                o(e.model), n(e.model), r._resetSchema(e.model.uri);
              })
            ),
            this._disposables.push({
              dispose: function() {
            ...
            monaco.editor.getModels().forEach(n);
        }
        return (
          (e.prototype.dispose = function() {
    ...
    function s(e) {
      if (e)
        return { start: a(e.getStartPosition()), end: a(e.getEndPosition()) };
    }
    function u(e) {
      if (e)
        return new n(
                ...
                if (e)
                  return e.map(function(e) {
                    return {
                      ...
                      location:
                        ((t = e.location),
                        { uri: r.parse(t.uri), range: u(t.range) })
                    };
                    var t;
                  });
              })
        ...
        (e.prototype.provideDocumentFormattingEdits = function(e, t, n) {
          ...
          return y(
            ...
            this._worker(r).then(function(e) {
              return e.format(r.toString(), null, p(t)).then(function(e) {
        ...
        (e.prototype.provideDocumentRangeFormattingEdits = function(
          ...
          return y(
            ...
            this._worker(o).then(function(e) {
              return e.format(o.toString(), s(t), p(n)).then(function(e) {
                if (e && 0 !== e.length) return e.map(f);
              });
            })
          );
    ...
    t.DocumentRangeFormattingEditProvider = v;
  }),
  (function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      var t = e(require, exports);
      ...
      (t.createScanner = function(i, e) {
        ...
        function t() {
          ...
          if (d(e)) {
            for (
              ;
              a++, (r += String.fromCharCode(e)), d((e = i.charCodeAt(a)));
  ...
  (function(e) {
    ...
    (t.format = function(r, e, t) {
      var n, o, i, a, s;
      if (e) {
        for (a = e.offset, s = a + e.length, i = a; 0 < i && !O(r, i - 1); )
          i--;
        for (var u = s; u < r.length && !O(r, u); ) u++;
        (o = r.substring(i, u)),
          (n = (function(e, t, n) {
            for (var r = 0, o = 0, i = n.tabSize || 4; r < e.length; ) {
              var a = e.charAt(r);
              if (" " === a) o++;
              else {
                if ("\t" !== a) break;
      ...
      for (; 17 !== b; ) {
        for (
          var _ = g.getTokenOffset() + g.getTokenLength() + i, C = m(), E = "";
          !l && (12 === C || 13 === C);

        )
          y(" ", _, g.getTokenOffset() + i),
            (_ = g.getTokenOffset() + g.getTokenLength() + i),
            (E = 12 === C ? p() : ""),
            (C = m());
        if (2 === C) 1 !== b && (d--, (E = p()));
        else if (4 === C) 3 !== b && (d--, (E = p()));
        else {
          switch (b) {
            case 3:
            case 1:
      ...
      (t.parseTree = function(e, r, t) {
        ...
        f(
          e,
          {
            ...
            onLiteralValue: function(e, t, n) {
              a({ type: l(e), offset: t, length: n, parent: o, value: e }),
                i(t + n);
            },
            onSeparator: function(e, t, n) {
              "property" === o.type &&
      ...
      (t.getNodeValue = function e(t) {
        ...
        if ("object" === t.type) {
          for (
            ...
            var i = o[r];
            n[i.children[0].value] = e(i.children[1]);
          }
          return n;
        }
        return t.value;
  ...
  (function(e) {
    ...
    function r(e, t, n, r, o) {
      for (
        var i, a = k.parseTree(e, []), s = void 0, u = void 0;
        0 < t.length &&
        ((u = t.pop()),
        void 0 === (s = k.findNodeAtLocation(a, t)) && void 0 !== n);

      )
        "string" == typeof u ? (((i = {})[u] = n), (n = i)) : (n = [n]);
      if (s) {
        if (
          "object" === s.type &&
          "string" == typeof u &&
          ...
          return _(
            ...
            (p =
              0 < h
                ...
                : 0 === s.children.length
                ? { offset: s.offset + 1, length: 0, content: g }
                : { offset: s.offset + 1, length: 0, content: g + "," }),
            r
          );
        }
        if (
          ...
          if (-1 === u) {
            ...
            if (0 === s.children.length)
              p = { offset: s.offset + 1, length: 0, content: g };
            else
              p = {
                offset:
          ...
          if (void 0 === n && 0 <= s.children.length) {
            ...
            if (1 === s.children.length)
              p = { offset: s.offset + 1, length: s.length - 2, content: "" };
  ...
  define("vs/language/json/tokenization", [
    "require",
    "exports",
    "jsonc-parser"
  ], function(e, g, h) {
          ...
          tokenize: function(e, t, n, r) {
            return (function(e, t, n, r, o) {
              ...
              for (u = { tokens: [], endState: n.clone() }; ; ) {
                var l = r + c.getPosition(),
                  d = "";
                if (17 === (s = c.scan())) break;
                if (l === r + c.getPosition())
                  throw new Error(
                    "Scanner did not advance, next 3 characters are: " +
                      t.substr(c.getPosition(), 3)
                  );
                switch ((a && (l -= i), (a = 0 < i), s)) {
                  case 1:
                  case 2:
                    (d = g.TOKEN_DELIM_OBJECT), (f = !1);
                    break;
                  case 3:
                  case 4:
                    (d = g.TOKEN_DELIM_ARRAY), (f = !1);
                    break;
                  case 6:
                    (d = g.TOKEN_DELIM_COLON), (f = !0);
                    break;
                  case 5:
                    (d = g.TOKEN_DELIM_COMMA), (f = !1);
                    break;
                  case 8:
                  case 9:
                    (d = g.TOKEN_VALUE_BOOLEAN), (f = !1);
                    break;
                  case 7:
                    (d = g.TOKEN_VALUE_NULL), (f = !1);
                    break;
                  case 10:
                    (d = f ? g.TOKEN_VALUE_STRING : g.TOKEN_PROPERTY_NAME),
                      (f = !1);
                    break;
                  case 11:
                    (d = g.TOKEN_VALUE_NUMBER), (f = !1);
                }
                if (e)
                  switch (s) {
                    case 12:
                      d = g.TOKEN_COMMENT_LINE;
                      break;
                    case 13:
                      d = g.TOKEN_COMMENT_BLOCK;
                  }
                (u.endState = new p(n.getStateData(), c.getTokenError(), f)),
                  u.tokens.push({ startIndex: l, scopes: d });
              }
              return u;
            })(o, e, t, n);
          }
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }),
      (t.setupMode = function(e) {
        ...
        t.push(
          ...
          t.push(new a.DiagnostcsAdapter(o, r)),
          t.push(
