 ...
 * monaco-html version: 2.1.0(3e40e40b22629289e2e1719f987e8ce964ecde46)
    ...
    var A = e("vscode-languageserver-types"),
      ...
      r = (function() {
        ...
        return (
          ...
          (e.prototype.doComplete = function(m, b, o, r) {
            ...
            function a(e, t) {
              ...
              return (
                ...
                (function(t) {
                  ...
                  (r[n] = n + '$1="$2"'),
                    o &&
                      o.roots.forEach(function(e) {
                        return (function t(e) {
                          e.attributeNames.forEach(function(e) {
                            I.startsWith(e, n) && !r[e] && (r[e] = e + '="$1"');
                          });
            ...
            for (
              ...
              switch (u) {
                ...
                case q.TokenType.AttributeValue:
                  if (k.getTokenOffset() <= _ && _ <= k.getTokenEnd())
                    return s(k.getTokenOffset(), k.getTokenEnd());
                  break;
                  ...
                  ? (S(),
                    (!n && !i) || A("&") || q() || A("(")
                      ? (A(" ") && (I.space_before_token = !0),
                        ":" === x() ? (_(), P("::")) : P(":"))
                      : (P(":"), r || ((r = !0), (I.space_before_token = !0))))
                  : '"' === v || "'" === v
                  ? (R(l), P(k(v)))
                  : ";" === v
                    ...
                    (this.get_tag = function(e) {
                      ...
                      return (
                        ...
                        this.Utils.in_array(T, this.Utils.single_token)
                          ...
                          ? e ||
                            (this.record_tag(T), (this.tag_type = "SCRIPT"))
                          : "style" === T &&
                            (-1 === w.search("type") ||
                              (-1 < w.search("type") &&
                                -1 < w.search("text/css")))
                          ? e || (this.record_tag(T), (this.tag_type = "STYLE"))
                          : "!" === T.charAt(0)
                          ? e ||
                            ((this.tag_type = "SINGLE"),
                            this.traverse_whitespace())
                          : e ||
                            ...
                            this.Utils.in_array(T, this.Utils.extra_liners) &&
