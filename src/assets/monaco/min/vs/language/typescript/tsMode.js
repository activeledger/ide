 ...
 *-----------------------------------------------------------------------------*/
define("vs/language/typescript/tokenization", [
  "require",
  "exports",
  ...
  Object.defineProperty(t, "__esModule", { value: !0 }),
    ((n = h = t.Language || (t.Language = {}))[(n.TypeScript = 0)] =
      "TypeScript"),
    (n[(n.EcmaScript5 = 1)] = "EcmaScript5"),
    (t.createTokenizationSupport = function(e) {
      var n = f.createClassifier(),
        r = e === h.TypeScript ? i : s,
        o = e === h.TypeScript ? a : c;
      return {
        getInitialState: function() {
          return new v(e, f.EndOfLineState.None, !1);
        },
        tokenize: function(e, t) {
          return (function(e, t, n, r, o) {
            var i = {
              tokens: [],
              endState: new v(r.language, f.EndOfLineState.None, !1)
            };
            function a(e, t) {
              (0 !== i.tokens.length &&
                i.tokens[i.tokens.length - 1].scopes === t) ||
                i.tokens.push({ startIndex: e, scopes: t });
            }
            var s = r.language === h.TypeScript;
            if (
              !s &&
              (function(e, t, n) {
              ...
              return i;
            var c = n.getClassificationsForLine(o, r.eolState, !0),
              u = 0;
            (i.endState.eolState = c.finalLexState),
              (i.endState.inJsDocComment =
                c.finalLexState === f.EndOfLineState.InMultiLineCommentTrivia &&
                (r.inJsDocComment || /\/\*\*.*$/.test(o)));
            for (var l = 0, p = c.entries; l < p.length; l++) {
              var d,
                g = p[l];
              if (g.classification === f.TokenClass.Punctuation) {
                var m = o.charCodeAt(u);
                (d = e[m] || t[g.classification]), a(u, d);
              } else
                g.classification === f.TokenClass.Comment
                  ? i.endState.inJsDocComment ||
                    /\/\*\*.*\*\//.test(o.substr(u, g.length))
                    ? a(u, s ? "comment.doc.ts" : "comment.doc.js")
                    : a(u, s ? "comment.ts" : "comment.js")
                  : a(u, t[g.classification] || "");
              u += g.length;
            }
            return i;
          })(r, o, n, t, e);
  ...
  var v = (function() {
    ...
    return (
      (t.prototype.clone = function() {
        return new t(this.language, this.eolState, this.inJsDocComment);
      }),
      (t.prototype.equals = function(e) {
        return (
          e === this ||
          (!!(e && e instanceof t) &&
            this.eolState === e.eolState &&
              this.inJsDocComment === e.inJsDocComment)
        );
      }),
      t
    );
  ...
  (i["(".charCodeAt(0)] = "delimiter.parenthesis.ts"),
    (i[")".charCodeAt(0)] = "delimiter.parenthesis.ts"),
    (i["{".charCodeAt(0)] = "delimiter.bracket.ts"),
    (i["}".charCodeAt(0)] = "delimiter.bracket.ts"),
    (i["[".charCodeAt(0)] = "delimiter.array.ts"),
    (i["]".charCodeAt(0)] = "delimiter.array.ts");
  var a = Object.create(null);
  (a[f.TokenClass.Identifier] = "identifier.ts"),
    (a[f.TokenClass.Keyword] = "keyword.ts"),
    (a[f.TokenClass.Operator] = "delimiter.ts"),
    (a[f.TokenClass.Punctuation] = "delimiter.ts"),
    (a[f.TokenClass.NumberLiteral] = "number.ts"),
    (a[f.TokenClass.RegExpLiteral] = "regexp.ts"),
    (a[f.TokenClass.StringLiteral] = "string.ts");
  var s = Object.create(null);
  (s["(".charCodeAt(0)] = "delimiter.parenthesis.js"),
    (s[")".charCodeAt(0)] = "delimiter.parenthesis.js"),
    (s["{".charCodeAt(0)] = "delimiter.bracket.js"),
    (s["}".charCodeAt(0)] = "delimiter.bracket.js"),
    (s["[".charCodeAt(0)] = "delimiter.array.js"),
    (s["]".charCodeAt(0)] = "delimiter.array.js");
  var c = Object.create(null);
  (c[f.TokenClass.Identifier] = "identifier.js"),
    (c[f.TokenClass.Keyword] = "keyword.js"),
    (c[f.TokenClass.Operator] = "delimiter.js"),
    (c[f.TokenClass.Punctuation] = "delimiter.js"),
    (c[f.TokenClass.NumberLiteral] = "number.js"),
    (c[f.TokenClass.RegExpLiteral] = "regexp.js"),
    (c[f.TokenClass.StringLiteral] = "string.js");
}),
      ...
      return (
        ...
        (e.prototype._convertDiagnostics = function(e, t) {
          ...
          return {
            ...
            endLineNumber: a,
            endColumn: s,
            message: c.flattenDiagnosticMessageText(t.messageText, "\n")
          };
        }),
        e
      );
            ...
            .then(function(e) {
              return e
                ? {
                    ...
                    label: e.name,
                    kind: a.convertKind(e.kind),
                    detail: c.displayPartsToString(e.displayParts),
                    documentation: c.displayPartsToString(e.documentation)
                  }
                : r;
            })
        );
              ...
              if (e) {
                ...
                return (
                  e.items.forEach(function(i) {
                    ...
                    (a.label += c.displayPartsToString(i.prefixDisplayParts)),
                      i.parameters.forEach(function(e, t, n) {
                        var r = c.displayPartsToString(e.displayParts),
                          o = {
                            label: r,
                            documentation: c.displayPartsToString(
                              e.documentation
                            )
                          };
                        (a.label += r),
                          a.parameters.push(o),
                          t < n.length - 1 &&
                            (a.label += c.displayPartsToString(
                              i.separatorDisplayParts
                            ));
                      }),
                      (a.label += c.displayPartsToString(i.suffixDisplayParts)),
                      t.signatures.push(a);
                  }),
                  t
                );
      ...
      (t.prototype.provideHover = function(e, t, n) {
        ...
        return _(
          ...
          this._worker(i)
            ...
            .then(function(e) {
              if (e) {
                var t = c.displayPartsToString(e.documentation),
                  n = e.tags
                    ? e.tags
                        .map(function(e) {
                          var t = "*@" + e.name + "*";
                        ...
                        .join("  \n\n")
                    : "",
                  r = c.displayPartsToString(e.displayParts);
                return {
                  range: o._textSpanToRange(i, e.textSpan),
                  contents: [{ value: r }, { value: t + (n ? "\n\n" + n : "") }]
                };
              }
            })
        );
    ...
    return (
      ...
      (t.prototype.provideDocumentSymbols = function(e, t) {
        ...
        return _(
          ...
          this._worker(u)
            .then(function(e) {
              return e.getNavigationBarItems(u.toString());
            })
            .then(function(e) {
              if (e) {
                var s = function(e, t, n) {
                    var r = {
                      ...
                      location: {
                        uri: u,
                        range: c._textSpanToRange(u, t.spans[0])
                      },
                      containerName: n
                    };
      ...
      return (
        ...
        (t._convertOptions = function(e) {
          return {
            ...
            IndentStyle: c.IndentStyle.Smart,
            NewLineCharacter: "\n",
    ...
    function o(e, t, n) {
      ...
      return (
        monaco.languages.registerCompletionItemProvider(
          t,
          new s.SuggestAdapter(o)
        ),
        monaco.languages.registerSignatureHelpProvider(
          t,
          new s.SignatureHelpAdapter(o)
        ),
        monaco.languages.registerHoverProvider(t, new s.QuickInfoAdapter(o)),
        monaco.languages.registerDocumentHighlightProvider(
          t,
          new s.OccurrencesAdapter(o)
        ),
        monaco.languages.registerDefinitionProvider(
          t,
          new s.DefinitionAdapter(o)
        ),
        monaco.languages.registerReferenceProvider(
          t,
          new s.ReferenceAdapter(o)
        ),
        monaco.languages.registerDocumentSymbolProvider(
          t,
          new s.OutlineAdapter(o)
        ),
        monaco.languages.registerDocumentRangeFormattingEditProvider(
          t,
          new s.FormatAdapter(o)
        ),
        monaco.languages.registerOnTypeFormattingEditProvider(
          t,
          new s.FormatOnTypeAdapter(o)
        ),
        new s.DiagnostcsAdapter(e, t, o),
        monaco.languages.setLanguageConfiguration(t, c),
        monaco.languages.setTokensProvider(t, i.createTokenizationSupport(n)),
        o
      );
    }
    Object.defineProperty(t, "__esModule", { value: !0 }),
      (t.setupTypeScript = function(e) {
        r = o(e, "typescript", i.Language.TypeScript);
      }),
      (t.setupJavaScript = function(e) {
        n = o(e, "javascript", i.Language.EcmaScript5);
      }),
      (t.getJavaScriptWorker = function() {
        return new monaco.Promise(function(e, t) {
          if (!n) return t("JavaScript not registered!");
          e(n);
        });
      }),
      (t.getTypeScriptWorker = function() {
        return new monaco.Promise(function(e, t) {
          if (!r) return t("TypeScript not registered!");
          e(r);
        });
      });
    var c = {
