...
define("vs/language/css/workerManager", ["require", "exports"], function(e, t) {
  ...
  (function(e) {
    ...
    var T,
      ...
      A = function() {};
    (t.DocumentLink = A),
      ((T = A = t.DocumentLink || (t.DocumentLink = {})).create = function(
        e,
        t
      ) {
      ...
      (t.setupMode = function(e) {
        ...
        t.push(
          monaco.languages.registerCompletionItemProvider(
            i,
            new a.CompletionAdapter(n)
          )
        ),
          t.push(
            monaco.languages.registerHoverProvider(i, new a.HoverAdapter(n))
          ),
          t.push(
            monaco.languages.registerDocumentHighlightProvider(
              i,
              new a.DocumentHighlightAdapter(n)
            )
          ),
          t.push(
            monaco.languages.registerDefinitionProvider(
              i,
              new a.DefinitionAdapter(n)
            )
          ),
          t.push(
            monaco.languages.registerReferenceProvider(
              i,
              new a.ReferenceAdapter(n)
            )
          ),
          t.push(
            monaco.languages.registerDocumentSymbolProvider(
              i,
              new a.DocumentSymbolAdapter(n)
            )
          ),
          t.push(
            monaco.languages.registerRenameProvider(i, new a.RenameAdapter(n))
          ),
          t.push(new a.DiagnostcsAdapter(i, n));
      });
  });
