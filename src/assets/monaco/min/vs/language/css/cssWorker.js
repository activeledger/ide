 ...
 * monaco-css version: 2.1.0(008a5a9f98f5e9afcaa1bbb40407ed2fd2d97b83)
...
!(function(e) {
  ...
  Object.defineProperty(t, "__esModule", { value: !0 }),
    ...
    (i.is = function(e) {
      var t = e;
      return O.defined(t) && o.is(t.start) && o.is(t.end);
    }),
    ((s = t.Location || (t.Location = {})).create = function(e, t) {
      return { uri: e, range: t };
    }),
    (s.is = function(e) {
      var t = e;
      return (
        O.defined(t) && r.is(t.range) && (O.string(t.uri) || O.undefined(t.uri))
      );
    }),
    ((a = t.DiagnosticSeverity || (t.DiagnosticSeverity = {})).Error = 1),
    (a.Warning = 2),
    (a.Information = 3),
    (a.Hint = 4),
    ((c = l = t.Diagnostic || (t.Diagnostic = {})).create = function(
      ...
      return (
        O.defined(n) && (s.severity = n),
        O.defined(r) && (s.code = r),
        O.defined(i) && (s.source = i),
        s
      );
    }),
    (c.is = function(e) {
    ...
    ((d = h = t.Command || (t.Command = {})).create = function(e, t) {
    ...
    ((m = p = t.TextEdit || (t.TextEdit = {})).replace = function(e, t) {
      return { range: e, newText: t };
    }),
    (m.insert = function(e, t) {
      return { range: { start: e, end: e }, newText: t };
    }),
    (m.del = function(e) {
      return { range: e, newText: "" };
    }),
    ((u = t.TextDocumentEdit || (t.TextDocumentEdit = {})).create = function(
      e,
      t
    ) {
  ...
  (t.WorkspaceChange = I),
    ...
    ((w = t.MarkupKind || (t.MarkupKind = {})).PlainText = "plaintext"),
    (w.Markdown = "markdown"),
    ...
    (v.Operator = 24),
    (v.TypeParameter = 25),
    ((x = t.InsertTextFormat || (t.InsertTextFormat = {})).PlainText = 1),
    (x.Snippet = 2),
    ...
    ((k = t.DocumentHighlightKind || (t.DocumentHighlightKind = {})).Text = 1),
    (k.Read = 2),
    (k.Write = 3),
    ...
    ((S = t.SymbolKind || (t.SymbolKind = {})).File = 1),
    (S.Module = 2),
    (S.Namespace = 3),
    (S.Package = 4),
    (S.Class = 5),
    ...
    ((t.SymbolInformation || (t.SymbolInformation = {})).create = function(
      ...
      var s = { name: e, kind: t, location: { uri: r, range: n } };
      return i && (s.containerName = i), s;
    }),
    ((F = t.CodeActionContext || (t.CodeActionContext = {})).create = function(
      e
    ) {
    ...
    (F.is = function(e) {
      var t = e;
      return O.defined(t) && O.typedArray(t.diagnostics, l.is);
    }),
    ...
    (C.is = function(e) {
      ...
      return (
        O.defined(t) &&
        r.is(t.range) &&
        (O.undefined(t.command) || h.is(t.command))
      );
    }),
    ((T = t.FormattingOptions || (t.FormattingOptions = {})).create = function(
      e,
      t
    ) {
  ...
  var P,
    ...
    D = function() {};
  (t.DocumentLink = D),
    ((P = D = t.DocumentLink || (t.DocumentLink = {})).create = function(e, t) {
    ...
    (t.DocumentLink = D),
    (t.EOL = ["\n", "\r\n", "\r"]),
    ((_ = t.TextDocument || (t.TextDocument = {})).create = function(
      e,
      t,
      n,
      r
    ...
    (_.applyEdits = function(e, t) {
      for (
        var n = e.getText(),
          r = (function e(t, n) {
            ...
            var r = (t.length / 2) | 0,
              ...
              s = t.slice(r);
            e(i, n), e(s, n);
            for (var o = 0, a = 0, l = 0; o < i.length && a < s.length; ) {
              var c = n(i[o], s[a]);
              t[l++] = c <= 0 ? i[o++] : s[a++];
            }
            for (; o < i.length; ) t[l++] = i[o++];
            for (; a < s.length; ) t[l++] = s[a++];
            return t;
          })(t, function(e, t) {
        ...
        var o = r[s],
          a = e.offsetAt(o.range.start),
          l = e.offsetAt(o.range.end);
        if (!(l <= i)) throw new Error("Ovelapping edit");
        (n = n.substring(0, a) + o.newText + n.substring(l, n.length)), (i = a);
      }
      return n;
    }),
    ((A =
  ...
  (R = O || (O = {})),
    ...
    (R.string = function(e) {
      return "[object String]" === z.call(e);
    }),
    (R.number = function(e) {
      return "[object Number]" === z.call(e);
    }),
    (R.func = function(e) {
      return "[object Function]" === z.call(e);
    }),
    (R.typedArray = function(e, t) {
  ...
  (function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define &&
        define.amd &&
        define("vscode-css-languageservice/parser/cssScanner", [
          "require",
          "exports"
        ], e);
  })(function(e, t) {
    ...
    var r = (function() {
      ...
      return (
        (e.prototype.substring = function(e, t) {
          return (
            void 0 === t && (t = this.position), this.source.substring(e, t)
          );
        }),
    ...
    var H = (function() {
      ...
      return (
        ...
        (e.prototype.scanNext = function(e) {
          ...
          if (this.stream.advanceIfChars([b, b, F]))
          ...
          if (this.stream.advanceIfChar(T))
            return (
              (t = ["#"]),
              this._name(t)
          ...
          if (this._number()) {
            ...
            if (
              ((t = [this.stream.substring(e, r)]),
              this.stream.advanceIfChar(w))
            )
          ...
          return null !== o
            ...
            : void 0 !== (o = W[this.stream.peekChar()])
            ? (this.stream.advance(1), this.finishToken(e, o))
            ...
            : this.stream.peekChar(0) === v && this.stream.peekChar(1) === f
        ...
        (e.prototype._matchWordAnyCase = function(n) {
          ...
          return (
            ...
            r === n.length || (this.stream.goBack(r / 2), !1)
          );
        }),
        ...
        (e.prototype.comment = function() {
          if (this.stream.advanceIfChars([P, v])) {
            var t = !1,
              n = !1;
            return (
              this.stream.advanceWhileChar(function(e) {
                return n && e === P ? ((t = !0), !1) : ((n = e === v), !0);
              }),
        ...
        (e.prototype._escape = function(e, t) {
          ...
          if (n === I) {
            ...
            if (0 < r) {
              try {
                var i = parseInt(
                  this.stream.substring(this.stream.pos() - r),
                  16
                );
                i && e.push(String.fromCharCode(i));
              } catch (e) {}
              return (
                n === z || n === N ? this.stream.advance(1) : this._newline([]),
                !0
              );
            }
            if (n !== A && n !== D && n !== _)
        ...
        (e.prototype._string = function(e) {
          if (this.stream.peekChar() === R || this.stream.peekChar() === O) {
...
!(function(e) {
  if ("object" == typeof module && "object" == typeof module.exports) {
    ...
    "function" == typeof define &&
      define.amd &&
      define("vscode-css-languageservice/parser/cssNodes", [
        "require",
        "exports"
      ], e);
})(function(e, t) {
  ...
  Object.defineProperty(t, "__esModule", { value: !0 }),
    ((n = i = t.NodeType || (t.NodeType = {}))[(n.Undefined = 0)] =
      "Undefined"),
    ...
    ((r = t.ReferenceType || (t.ReferenceType = {}))[(r.Mixin = 0)] = "Mixin"),
    (r[(r.Rule = 1)] = "Rule"),
    ...
    (t.getNodePath = function(e, t) {
      for (var n = s(e, t), r = []; n; ) r.unshift(n), (n = n.parent);
      return r;
    }),
    (t.getParentDeclaration = function(e) {
      var t = e.findParent(i.Declaration);
  ...
  var o = (function() {
      ...
      return (
        ...
        Object.defineProperty(e.prototype, "type", {
          get: function() {
            return this.nodeType || i.Undefined;
          },
          set: function(e) {
            this.nodeType = e;
          },
        ...
        (e.prototype.adoptChild = function(e, t) {
          ...
          var r = (e.parent = this).children;
          return (
            r || (r = this.children = []),
            -1 !== t ? r.splice(t, 0, e) : r.push(e),
            e
          );
        }),
    ...
    p = (function(n) {
      ...
      return (
        ...
        (e.prototype.isNested = function() {
          return this.parent && null !== this.parent.findParent(i.Declarations);
        }),
        e
      );
    })((t.BodyDeclaration = d));
  ...
  var g = (function(n) {
    ...
    b = (function(n) {
      ...
      return (
        ...
        Object.defineProperty(e.prototype, "type", {
          get: function() {
            return i.CustomPropertyDeclaration;
          },
          enumerable: !0,
          configurable: !0
        }),
  ...
  var w = (function(n) {
    ...
    return (
      ...
      (r.prototype.setProperty = function(e) {
        return this.setNode("property", e);
      }),
      (r.prototype.getProperty = function() {
        return this.property;
      }),
      (r.prototype.getFullPropertyName = function() {
        ...
        if (this.parent instanceof h && this.parent.getParent() instanceof O) {
          ...
          if (t instanceof r) return t.getFullPropertyName() + e;
        }
        return e;
      }),
      (r.prototype.getNonPrefixedPropertyName = function() {
      ...
      (r.prototype.setNestedProperties = function(e) {
        return this.setNode("nestedProprties", e);
      }),
      (r.prototype.getNestedProperties = function() {
      ...
      (e.prototype.getValue = function() {
        for (
          var e,
            ...
            o = 0,
            a = t.length;
          o < a && ((i <= (e = t.charCodeAt(o)) && e <= s) || e === r);
          o++
        )
          n += 1;
        return {
  ...
  (t.GuardCondition = ae),
    ((oe = t.Level || (t.Level = {}))[(oe.Ignore = 1)] = "Ignore"),
    (oe[(oe.Warning = 2)] = "Warning"),
    (oe[(oe.Error = 4)] = "Error");
  var le = (function() {
  ...
  t.ParseErrorCollector = ce;
}),
  define("vscode-nls/vscode-nls", ["require", "exports"], function(e, t) {
    "use strict";
    function n(e, t) {
      for (var n, r, i = [], s = 2; s < arguments.length; s++)
        i[s - 2] = arguments[s];
      return (
        (n = t),
        0 === (r = i).length
  ...
  (function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define &&
        define.amd &&
        define("vscode-css-languageservice/parser/cssErrors", [
          "require",
          "exports",
          "vscode-nls"
        ], e);
    ...
    (t.CSSIssueType = r),
      (t.ParseError = {
        ...
        PageDirectiveOrDeclarationExpected: new r(
  ...
  (function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define &&
        define.amd &&
        define("vscode-css-languageservice/data/browsers", [
          "require",
          "exports"
        ], e);
  })(function(e, t) {
        ...
        css: {
          ...
          properties: [
            ...
            },
            {
              ...
              restriction: "enum",
              values: [
                { name: "auto", desc: "The element does not clip." },
                { name: "rect()" }
              ]
            },
            {
            ...
            },
            {
              ...
              restriction: "enum",
              values: [
                { name: "auto", desc: "Fills columns sequentially." },
                { name: "balance" }
              ]
            },
            {
            ...
            },
            {
              ...
              values: [
                { name: "hide" },
                { name: "-moz-show-background", browsers: "FF" },
                { name: "show" }
              ]
            },
            {
            ...
            },
            {
              ...
              restriction: "enum",
              values: [
                { name: "inline-end", browsers: "FF55" },
                { name: "inline-start", browsers: "FF55" },
                {
                  name: "left",
                  desc:
            ...
            },
            {
              ...
              restriction: "number",
              values: [
                { name: "none", desc: "Do not preserve the font’s x-height." }
              ]
            },
            {
              name: "font-stretch",
            ...
            },
            {
              ...
              values: [
                ...
                { name: "style", desc: "Allow synthetic italic faces." },
                { name: "weight" }
              ]
            },
            {
            ...
            },
            {
              ...
              restriction: "length",
              values: [
                { name: "none", desc: "No perspective transform is applied." }
              ]
            },
            {
            ...
            },
            {
              ...
              restriction: "enum",
              values: [
                { name: "none", desc: "The element is not zoomable." },
                { name: "zoom" }
              ]
            },
            {
            ...
            },
            {
              ...
              values: [
                { name: "grippers" },
                { name: "none", desc: "Grippers are always off." }
              ]
            },
            {
              name: "-ms-transform",
            ...
            },
            {
              ...
              restriction: "enum",
              values: [
                { name: "auto", desc: "Scrolls in an instant fashion." },
                { name: "smooth" }
              ]
            },
            {
            ...
            },
            {
              ...
              values: [
                { name: "margin-box" },
                { name: "none", desc: "The float area is unaffected." }
              ]
            },
            {
              ...
              restriction: "enum",
              values: [
                { name: "auto", desc: "Suppresses aural rendering." },
                { name: "crispEdges" },
                {
            ...
            },
            {
              ...
              values: [
                { name: "none", desc: "Indicates that no dashing is used." }
              ]
            },
            {
            ...
            },
            {
              ...
              values: [
                { name: "flat" },
                { name: "preserve-3d", browsers: "E,C36,FF16,O23,S9" }
              ]
            },
            {
              name: "transition",
  ...
  (function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define &&
        define.amd &&
        define("vscode-css-languageservice/services/languageFacts", [
          "require",
          "exports",
          "../parser/cssNodes",
          "../data/browsers",
    ...
    (a.colors = {
      ...
      (a.lineWidthKeywords = ["medium", "thick", "thin"]),
      (a.boxKeywords = {
        "border-box":
      ...
      (a.isColorConstructor = function(e) {
        var t = e.getName();
        return !!t && /^(rgb|rgba|hsl|hsla)$/gi.test(t);
      }),
      (a.isColorValue = function(e) {
        if (e.type === l.NodeType.HexColorValue) return !0;
        if (e.type === l.NodeType.Function) return this.isColorConstructor(e);
        if (e.type === l.NodeType.Identifier) {
          if (e.parent && e.parent.type !== l.NodeType.Term) return !1;
          var t = e.getText().toLowerCase();
          if ("none" === t) return !1;
          if (a.colors[t]) return !0;
        }
        return !1;
      });
    var r = 48,
    ...
    function d(e) {
      ...
      switch (e.length) {
        case 4:
          return {
            red: (17 * h(e.charCodeAt(1))) / 255,
            green: (17 * h(e.charCodeAt(2))) / 255,
            blue: (17 * h(e.charCodeAt(3))) / 255,
            alpha: 1
          };
        case 5:
          return {
            ...
            green: (17 * h(e.charCodeAt(2))) / 255,
            blue: (17 * h(e.charCodeAt(3))) / 255,
            alpha: (17 * h(e.charCodeAt(4))) / 255
          };
        case 7:
          return {
            red: (16 * h(e.charCodeAt(1)) + h(e.charCodeAt(2))) / 255,
            green: (16 * h(e.charCodeAt(3)) + h(e.charCodeAt(4))) / 255,
            blue: (16 * h(e.charCodeAt(5)) + h(e.charCodeAt(6))) / 255,
            alpha: 1
          };
        case 9:
          return {
            ...
            green: (16 * h(e.charCodeAt(3)) + h(e.charCodeAt(4))) / 255,
            blue: (16 * h(e.charCodeAt(5)) + h(e.charCodeAt(6))) / 255,
            alpha: (16 * h(e.charCodeAt(7)) + h(e.charCodeAt(8))) / 255
          };
      }
      return null;
    }
    function p(e, t, n, r) {
      if ((void 0 === r && (r = 1), 0 === t))
        return { red: n, green: n, blue: n, alpha: r };
    ...
    function u(e) {
      ...
      if (e)
        for (var r = 0, i = e.split(","); r < i.length; r++) {
          var s = i[r];
          if ("all" === (s = s.trim())) (t.all = !0), (n = Number.MAX_VALUE);
          else if ("none" !== s)
            for (var o in a.browserNames)
              0 === s.indexOf(o) &&
                ((t[o] = s.substring(o.length).trim()), n++);
        }
      else (t.all = !0), (n = Number.MAX_VALUE);
      return (t.count = n), (t.onCodeComplete = 0 < n), t;
    }
    (a.hexDigit = h),
      (a.colorFromHex = d),
      (a.colorFrom256RGB = function(e, t, n, r) {
        return (
          void 0 === r && (r = 1),
      ...
      (a.getColorValue = function(e) {
        if (e.type === l.NodeType.HexColorValue) return d(e.getText());
        if (e.type === l.NodeType.Function) {
          var t = e,
            n = t.getName(),
            r = t.getArguments().getChildren();
          if (!n || r.length < 3 || 4 < r.length) return null;
          try {
            var i = 4 === r.length ? m(r[3], 1) : 1;
            if ("rgb" === n || "rgba" === n)
              return {
                red: m(r[0], 255),
                green: m(r[1], 255),
        ...
        } else if (e.type === l.NodeType.Identifier) {
          if (e.parent && e.parent.type !== l.NodeType.Term) return null;
          var s = e.getText().toLowerCase();
      ...
      (a.isKnownProperty = function(e) {
        return !!e && ((e = e.toLowerCase()), w().hasOwnProperty(e));
      }),
      (a.isCommonValue = function(e) {
        return 1 < e.browsers.count;
      }),
      (a.getPageBoxDirectives = function() {
        return [
          "@bottom-center",
          "@bottom-left",
          "@bottom-left-corner",
      ...
      (a.getEntryDescription = function(e) {
        var t = e.description || "",
          n = this.getBrowserLabel(e.browsers);
        return n && (t && (t += "\n"), (t = t + "(" + n + ")")), t;
      }),
      (a.getBrowserLabel = function(e) {
        var t = "";
        if (!e || e.all || 0 === e.count) return null;
        for (var n in a.browserNames)
          if ("string" == typeof e[n]) {
            0 < t.length && (t += ", "), (t += a.browserNames[n]);
            var r = e[n];
            0 < r.length && (t = t + " " + r);
          }
        return t;
      ...
      g = (function() {
        ...
        return (
          ...
          Object.defineProperty(e.prototype, "description", {
            get: function() {
              return this.data.desc || t.descriptions[this.data.name];
            },
            enumerable: !0,
            configurable: !0
          }),
          Object.defineProperty(e.prototype, "browsers", {
            get: function() {
              return (
                this.browserEntry ||
                  (this.browserEntry = u(this.data.browsers)),
                this.browserEntry
              );
            },
            enumerable: !0,
    ...
    a.getProperties = w;
    var v,
      x = t.data.css.atdirectives;
    a.getAtDirectives = function() {
      if (!v) {
        v = [];
    ...
    var k,
      S = t.data.css.pseudoelements;
    a.getPseudoElements = function() {
      if (!k) {
        k = [];
    ...
    var F,
      C = t.data.css.pseudoclasses;
    (a.getPseudoClasses = function() {
      if (!F) {
        F = [];
  ...
  (function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define &&
        define.amd &&
        define("vscode-css-languageservice/parser/cssParser", [
          "require",
          "exports",
          "./cssScanner",
          "./cssNodes",
    ...
    var o = e("./cssScanner"),
      a = e("./cssNodes"),
      l = e("./cssErrors"),
      n = e("../services/languageFacts"),
      r = (function() {
        function e(e) {
          void 0 === e && (e = new o.Scanner()),
        ...
        return (
          (e.prototype.peekIdent = function(e) {
            return (
              o.TokenType.Ident === this.token.type &&
          ...
          (e.prototype.peekKeyword = function(e) {
            return (
              o.TokenType.AtKeyword === this.token.type &&
              e.length === this.token.text.length &&
              e === this.token.text.toLowerCase()
            );
          }),
          (e.prototype.peekDelim = function(e) {
            return (
              o.TokenType.Delim === this.token.type && e === this.token.text
            );
          }),
          ...
          (e.prototype.acceptOneKeyword = function(e) {
            if (o.TokenType.AtKeyword === this.token.type)
              for (var t = 0, n = e; t < n.length; t++) {
                var r = n[t];
                if (
                  r.length === this.token.text.length &&
                  r === this.token.text.toLowerCase()
                )
          ...
          (e.prototype.resync = function(e, t) {
            for (;;) {
              ...
              if (this.token.type === o.TokenType.EOF) return !1;
          ...
          (e.prototype.finish = function(e, t, n, r) {
            if (
              ...
              (t && this.markError(e, t, n, r), null !== this.prevToken)
            ) {
            ...
            do {
              ...
              do {
                ...
                for (
                  ...
                  this.accept(o.TokenType.SemiColon) ||
                  this.accept(o.TokenType.CDO) ||
                  this.accept(o.TokenType.CDC);

                )
                  (n = !0), (t = !1);
              } while (n);
              if (this.peek(o.TokenType.EOF)) break;
              t ||
                ...
                (t = !0)),
                this.consumeToken();
            } while (!this.peek(o.TokenType.EOF));
          ...
          (e.prototype._tryParseRuleset = function(e) {
            ...
            if (this._parseSelector(e)) {
              for (
                ;
                this.accept(o.TokenType.Comma) && this._parseSelector(e);

              );
              if (this.accept(o.TokenType.CurlyL))
          ...
          (e.prototype._parseRuleset = function(e) {
            ...
            for (
              ...
              t.getSelectors().addChild(this._parseSelector(e));
          ...
          (e.prototype._parseDeclarations = function(e) {
            ...
            if (!this.accept(o.TokenType.CurlyL)) return null;
            for (
              var n = e();
              t.addChild(n) && !this.peek(o.TokenType.CurlyR);
              ...
              for (; this.accept(o.TokenType.SemiColon); );
              n = e();
            }
            return this.accept(o.TokenType.CurlyR)
              ? this.finish(t)
          ...
          (e.prototype._tryParseCustomPropertyDeclaration = function() {
            if (!this.peekRegExp(o.TokenType.Ident, /^--/)) return null;
            ...
            var t = this.mark();
            if (this.peek(o.TokenType.CurlyL)) {
              var n = this.create(a.CustomPropertySet),
                r = this._parseDeclarations(
            ...
            return i &&
              !i.isErroneous(!0) &&
              (this._parsePrio(), this.peek(o.TokenType.SemiColon))
              ? (e.setValue(i),
                (e.semicolonPosition = this.token.offset),
                this.finish(e))
              : (this.restoreAtMark(t),
          ...
          (e.prototype._parseCustomPropertyValue = function() {
            ...
            e: for (;;) {
              switch (this.token.type) {
                case o.TokenType.SemiColon:
                case o.TokenType.Exclamation:
                  if (t()) break e;
                  break;
                case o.TokenType.CurlyL:
                  n++;
                  break;
                case o.TokenType.CurlyR:
                  if (--n < 0) {
                    if (0 === r && 0 === i) break e;
                    return this.finish(e, l.ParseError.LeftCurlyExpected);
                  }
                  break;
                case o.TokenType.ParenthesisL:
                  r++;
                  break;
                case o.TokenType.ParenthesisR:
                  if (--r < 0)
                    return this.finish(e, l.ParseError.LeftParenthesisExpected);
                  break;
                case o.TokenType.BracketL:
                  i++;
                  break;
                case o.TokenType.BracketR:
                  if (--i < 0)
                    return this.finish(
                      e,
                  ...
                  break;
                case o.TokenType.BadString:
                  break e;
                case o.TokenType.EOF:
                  var s = l.ParseError.RightCurlyExpected;
                  return (
                    0 < i
                      ? (s = l.ParseError.RightSquareBracketExpected)
                      : 0 < r && (s = l.ParseError.RightParenthesisExpected),
                    this.finish(e, s)
                  );
              }
              this.consumeToken();
          ...
          (e.prototype._tryToParseDeclaration = function() {
            var e = this.mark();
            return this._parseProperty() && this.accept(o.TokenType.Colon)
          ...
          (e.prototype._parseCharset = function() {
            if (!this.peek(o.TokenType.Charset)) return null;
            var e = this.create(a.Node);
            return (
              this.consumeToken(),
          ...
          (e.prototype._parseKeyframe = function() {
            if (!this.peekRegExp(o.TokenType.AtKeyword, this.keyframeRegex))
              return null;
          ...
          (e.prototype._parseKeyframeSelector = function() {
            ...
            if (
              !e.addChild(this._parseIdent()) &&
              !this.accept(o.TokenType.Percentage)
            )
              return null;
          ...
          (e.prototype._tryParseKeyframeSelector = function() {
            ...
            for (; this.accept(o.TokenType.Comma); )
              if (
                ...
                return this.restoreAtMark(t), null;
            return this.peek(o.TokenType.CurlyL)
              ? this._parseBody(e, this._parseRuleSetDeclaration.bind(this))
              : (this.restoreAtMark(t), null);
          }),
          ...
          (e.prototype._parseSupportsCondition = function() {
            ...
            if (this.acceptIdent("not"))
              ...
              (e.addChild(this._parseSupportsConditionInParens()),
              this.peekRegExp(o.TokenType.Ident, /^(and|or)$/i))
            )
              for (var t = this.token.text; this.acceptIdent(t); )
                e.addChild(this._parseSupportsConditionInParens());
            return this.finish(e);
          }),
          (e.prototype._parseSupportsConditionInParens = function() {
            ...
            if (this.peek(o.TokenType.Ident)) {
              var t = this.mark();
              if (
                (this.consumeToken(),
                ...
                for (
                  var n = 1;
                  this.token.type !== o.TokenType.EOF && 0 !== n;

                )
                  this.token.type === o.TokenType.ParenthesisL
                    ? n++
                    : this.token.type === o.TokenType.ParenthesisR && n--,
                    this.consumeToken();
                return this.finish(e);
              }
              this.restoreAtMark(t);
          ...
          (e.prototype._parseMediaQueryList = function() {
            ...
            if (!e.addChild(this._parseMediaQuery([o.TokenType.CurlyL])))
          ...
          (e.prototype._parseMediaQuery = function(e) {
            var t = this.create(a.MediaQuery),
              n = !0,
              r = !1;
            if (!this.peek(o.TokenType.ParenthesisL)) {
              if (
          ...
          (e.prototype._parsePageMarginBox = function() {
            ...
            return (
              this.acceptOneKeyword(n.getPageBoxDirectives()) ||
                this.markError(
                  e,
          ...
          (e.prototype._parsePageSelector = function() {
            if (!this.peek(o.TokenType.Ident) && !this.peek(o.TokenType.Colon))
              return null;
            var e = this.create(a.Node);
            return (
              e.addChild(this._parseIdent()),
              this.accept(o.TokenType.Colon) && !e.addChild(this._parseIdent())
                ? this.finish(e, l.ParseError.IdentifierExpected)
                : this.finish(e)
            );
          }),
          (e.prototype._parseDocument = function() {
            ...
            return (
              this.consumeToken(),
              this.resync([], [o.TokenType.CurlyL]),
          ...
          (e.prototype._parseOperator = function() {
            if (
              ...
              this.peekDelim("+") ||
              this.peekDelim("-") ||
              this.peek(o.TokenType.Dashmatch) ||
              this.peek(o.TokenType.Includes) ||
              this.peek(o.TokenType.SubstringOperator) ||
              this.peek(o.TokenType.PrefixOperator) ||
              this.peek(o.TokenType.SuffixOperator) ||
              this.peekDelim("=")
            ) {
          ...
          (e.prototype._parseHash = function() {
            if (!this.peek(o.TokenType.Hash) && !this.peekDelim("#"))
              return null;
          ...
          (e.prototype._parseAttrib = function() {
            if (!this.peek(o.TokenType.BracketL)) return null;
            var e = this.create(a.AttributeSelector);
            return (
              this.consumeToken(),
              e.setNamespacePrefix(this._parseNamespacePrefix()),
              e.setExpression(this._parseBinaryExpr()),
              this.accept(o.TokenType.BracketR)
                ? this.finish(e)
          ...
          (e.prototype._parsePseudo = function() {
            ...
            var e = this.mark(),
              n = this.createNode(a.NodeType.PseudoSelector);
            if ((this.consumeToken(), !this.hasWhitespace())) {
              if (this.accept(o.TokenType.Colon) && this.hasWhitespace())
                return this.finish(n, l.ParseError.IdentifierExpected);
              if (!n.addChild(this._parseIdent()))
                return this.finish(n, l.ParseError.IdentifierExpected);
              if (
                !this.hasWhitespace() &&
                ...
                if (
                  (n.addChild(
                    this.try(function() {
                      var e = t._parseSimpleSelector();
                      return e && t.peek(o.TokenType.ParenthesisR) ? e : null;
                    }) || this._parseBinaryExpr()
                  ),
                  !this.accept(o.TokenType.ParenthesisR))
                )
                  return this.finish(n, l.ParseError.RightParenthesisExpected);
              }
          ...
          (e.prototype._parsePrio = function() {
            if (!this.peek(o.TokenType.Exclamation)) return null;
            var e = this.createNode(a.NodeType.Prio);
            return this.accept(o.TokenType.Exclamation) &&
          ...
          (e.prototype._parseExpr = function(e) {
            ...
            if (!t.addChild(this._parseNamedLine() || this._parseBinaryExpr()))
              return null;
            for (;;) {
              if (this.peek(o.TokenType.Comma)) {
                if (e) return this.finish(t);
                this.consumeToken();
              }
              if (
                !t.addChild(this._parseNamedLine() || this._parseBinaryExpr())
              )
                break;
            }
            return this.finish(t);
          ...
          (e.prototype._parseNamedLine = function() {
            ...
            return this.accept(o.TokenType.BracketR)
              ? this.finish(e)
              : this.finish(e, l.ParseError.RightSquareBracketExpected);
          }),
          ...
          (e.prototype._parseNumeric = function() {
            if (
              this.peek(o.TokenType.Num) ||
              this.peek(o.TokenType.Percentage) ||
              this.peek(o.TokenType.Resolution) ||
              this.peek(o.TokenType.Length) ||
              this.peek(o.TokenType.EMS) ||
              this.peek(o.TokenType.EXS) ||
              this.peek(o.TokenType.Angle) ||
              this.peek(o.TokenType.Time) ||
              this.peek(o.TokenType.Dimension) ||
              this.peek(o.TokenType.Freq)
            ) {
          ...
          (e.prototype._parseStringLiteral = function() {
            if (
              !this.peek(o.TokenType.String) &&
              !this.peek(o.TokenType.BadString)
            )
              return null;
          ...
          (e.prototype._parseURILiteral = function() {
            if (!this.peekRegExp(o.TokenType.Ident, /^url(-prefix)?$/i))
              return null;
            var e = this.mark(),
              t = this.createNode(a.NodeType.URILiteral);
            return (
              this.accept(o.TokenType.Ident),
              this.hasWhitespace() || !this.peek(o.TokenType.ParenthesisL)
                ? (this.restoreAtMark(e), null)
          ...
          (e.prototype._parseURLArgument = function() {
            var e = this.create(a.Node);
            return this.accept(o.TokenType.String) ||
              this.accept(o.TokenType.BadString) ||
              this.acceptUnquotedString()
              ? this.finish(e)
              : null;
          }),
          (e.prototype._parseIdent = function(e) {
            if (!this.peek(o.TokenType.Ident)) return null;
            var t = this.create(a.Identifier);
            return (
              e && (t.referenceTypes = e),
              (t.isCustomProperty = this.peekRegExp(o.TokenType.Ident, /^--/)),
              this.consumeToken(),
              this.finish(t)
            );
          }),
          ...
          (e.prototype._parseFunctionIdentifier = function() {
            ...
            if (
              ...
              if (this.accept(o.TokenType.Colon))
                for (
                  ;
                  this.accept(o.TokenType.Ident) && this.acceptDelim(".");
  ...
  (function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define &&
        define.amd &&
        define("vscode-css-languageservice/utils/arrays", [
          "require",
          "exports"
        ], e);
  })(function(e, t) {
...
!(function(e) {
  if ("object" == typeof module && "object" == typeof module.exports) {
    ...
    "function" == typeof define &&
      define.amd &&
      define("vscode-css-languageservice/parser/cssSymbolScope", [
        "require",
        "exports",
        "./cssNodes",
        "../utils/arrays"
    ...
    r = (function() {
      ...
      return (
        ...
        (e.prototype.findInScope = function(e, t) {
          void 0 === t && (t = 0);
          var n = e + t,
            r = s.findFirst(this.children, function(e) {
              return e.offset > n;
            });
          if (0 === r) return this;
          var i = this.children[r - 1];
          return i.offset <= e && i.offset + i.length >= e + t
            ? i.findInScope(e, t)
            : this;
        }),
  ...
  var i = (function() {
    ...
    return (
      ...
      (e.prototype.addSymbolToChildScope = function(e, t, n, r, i) {
        e && -1 !== e.offset && this.addScope(e).addSymbol(new o(n, r, t, i));
      }),
      (e.prototype.visitNode = function(e) {
        switch (e.type) {
          case h.NodeType.Keyframe:
            return (
              this.addSymbol(e, e.getName(), null, h.ReferenceType.Keyframe), !0
            );
          case h.NodeType.CustomPropertyDeclaration:
            return this.visitCustomPropertyDeclarationNode(e);
          case h.NodeType.VariableDeclaration:
            return this.visitVariableDeclarationNode(e);
          case h.NodeType.Ruleset:
            return this.visitRuleSet(e);
          case h.NodeType.MixinDeclaration:
            return (
              this.addSymbol(e, e.getName(), null, h.ReferenceType.Mixin), !0
            );
          case h.NodeType.FunctionDeclaration:
            return (
              this.addSymbol(e, e.getName(), null, h.ReferenceType.Function), !0
            );
          case h.NodeType.FunctionParameter:
            return this.visitFunctionParameterNode(e);
          case h.NodeType.Declarations:
            ...
            return (
              n &&
                this.addSymbolToChildScope(
                  ...
                  t.variable.getName(),
                  null,
                  h.ReferenceType.Variable
                ),
              !0
            );
          case h.NodeType.Each:
            var r = e,
              i = r.getDeclarations();
            if (i)
              for (
                var s = 0, o = r.getVariables().getChildren();
                s < o.length;
                s++
              ) {
                var a = o[s];
      ...
      (e.prototype.visitRuleSet = function(e) {
        for (
          var t = this.scope.findScope(e.offset, e.length),
            n = 0,
            r = e.getSelectors().getChildren();
          n < r.length;
          n++
        ) {
          var i = r[n];
          i instanceof h.Selector &&
            1 === i.getChildren().length &&
            t.addSymbol(
              new o(i.getChild(0).getText(), null, i, h.ReferenceType.Rule)
            );
        }
        return !0;
      }),
      (e.prototype.visitVariableDeclarationNode = function(e) {
        ...
        return this.addSymbol(e, e.getName(), t, h.ReferenceType.Variable), !0;
      }),
      ...
      (e.prototype.addCSSVariable = function(e, t, n, r) {
        -1 !== e.offset &&
          this.getGlobalScope(e, t, r).addSymbol(new o(t, n, e, r));
      }),
  ...
  var a = (function() {
    function e(e) {
      (this.global = new n()), e.acceptVisitor(new i(this.global));
    }
    return (
      (e.prototype.findSymbolsAtOffset = function(e, t) {
        for (var n = this.global.findScope(e, 0), r = [], i = {}; n; ) {
          for (var s = n.getSymbols(), o = 0; o < s.length; o++) {
            var a = s[o];
      ...
      (e.prototype.internalFindSymbol = function(e, t) {
        var n = e;
        if (
          (e.parent instanceof h.FunctionParameter &&
            e.parent.getParent() instanceof h.BodyDeclaration &&
            (n = e.parent.getParent().getDeclarations()),
          e.parent instanceof h.FunctionArgument &&
            e.parent.getParent() instanceof h.Function)
        ) {
          var r = e.parent.getParent().getIdentifier();
          if (r) {
            var i = this.internalFindSymbol(r, [h.ReferenceType.Function]);
            i && (n = i.node.getDeclarations());
          }
        }
        if (!n) return null;
        for (
          var s = e.getText(), o = this.global.findScope(n.offset, n.length);
          o;
      ...
      (e.prototype.evaluateReferenceTypes = function(e) {
        if (e instanceof h.Identifier) {
          var t = e.referenceTypes;
          if (t) return t;
          if (e.isCustomProperty) return [h.ReferenceType.Variable];
          var n = h.getParentDeclaration(e);
          if (n) {
            var r = n.getNonPrefixedPropertyName();
            if (
              ("animation" === r || "animation-name" === r) &&
              n.getValue() &&
              n.getValue().offset === e.offset
            )
              return [h.ReferenceType.Keyframe];
          }
        } else if (e instanceof h.Variable) return [h.ReferenceType.Variable];
        return e.findParent(h.NodeType.Selector)
          ? [h.ReferenceType.Rule]
          : e.findParent(h.NodeType.ExtendsReference)
          ? [h.ReferenceType.Rule]
          : null;
      }),
      (e.prototype.findSymbolFromNode = function(e) {
        if (!e) return null;
        for (; e.type === h.NodeType.Interpolation; ) e = e.getParent();
  ...
  (function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define &&
        define.amd &&
        define("vscode-css-languageservice/utils/strings", [
          "require",
          "exports"
        ], e);
  })(function(e, t) {
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }),
      ...
      (t.difference = function(e, t, n) {
        ...
        for (i = 0; i < e.length + 1; ++i) o.push(a);
        for (i = 1; i < e.length + 1; ++i)
          for (s = 1; s < t.length + 1; ++s)
            e[i - 1] === t[s - 1]
              ? (o[i][s] = o[i - 1][s - 1] + 1)
              : (o[i][s] = Math.max(o[i - 1][s], o[i][s - 1]));
  ...
  (function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define &&
        define.amd &&
        define("vscode-css-languageservice/services/cssCompletion", [
          "require",
          "exports",
          "../parser/cssNodes",
    ...
    "use strict";
    Object.defineProperty(t, "__esModule", { value: !0 });
    var w = e("../parser/cssNodes"),
      n = e("../parser/cssSymbolScope"),
      v = e("./languageFacts"),
      x = e("../utils/strings"),
      k = e("vscode-languageserver-types"),
      l = e("vscode-nls").loadMessageBundle(),
      S = k.InsertTextFormat.Snippet,
      r = (function() {
        function e(e) {
          void 0 === e && (e = null),
            (this.completionParticipants = []),
            (this.valueTypes = [
              w.NodeType.Identifier,
              w.NodeType.Value,
              w.NodeType.StringLiteral,
              w.NodeType.URILiteral,
              w.NodeType.NumericValue,
              w.NodeType.HexColorValue,
              w.NodeType.VariableName,
              w.NodeType.Prio
            ]),
        ...
        return (
          ...
          (e.prototype.doComplete = function(e, t, n) {
            (this.offset = e.offsetAt(t)),
              ...
              (this.defaultReplaceRange = k.Range.create(
                k.Position.create(
                  this.position.line,
            ...
            try {
              ...
              this.nodePath = w.getNodePath(this.styleSheet, this.offset);
              for (var i = this.nodePath.length - 1; 0 <= i; i--) {
                var s = this.nodePath[i];
                if (s instanceof w.Property)
                  this.getCompletionsForDeclarationProperty(s.getParent(), r);
                else if (s instanceof w.Expression)
                  this.getCompletionsForExpression(s, r);
                else if (s instanceof w.SimpleSelector) {
                  var o = s.findParent(w.NodeType.ExtendsReference);
                  if (o) this.getCompletionsForExtendsReference(o, s, r);
                  else {
                    var a = s.findParent(w.NodeType.Ruleset);
                    this.getCompletionsForSelector(a, a && a.isNested(), r);
                  }
                } else
                  s instanceof w.FunctionArgument
                    ? this.getCompletionsForFunctionArgument(
                        s,
                        s.getParent(),
                        r
                      )
                    : s instanceof w.Declarations
                    ? this.getCompletionsForDeclarations(s, r)
                    : s instanceof w.VariableDeclaration
                    ? this.getCompletionsForVariableDeclaration(s, r)
                    : s instanceof w.RuleSet
                    ? this.getCompletionsForRuleSet(s, r)
                    : s instanceof w.Interpolation
                    ? this.getCompletionsForInterpolation(s, r)
                    : s instanceof w.FunctionDeclaration
                    ? this.getCompletionsForFunctionDeclaration(s, r)
                    : s instanceof w.MixinReference
                    ? this.getCompletionsForMixinReference(s, r)
                    : s instanceof w.Function
                    ? this.getCompletionsForFunctionArgument(null, s, r)
                    : s instanceof w.Supports
                    ? this.getCompletionsForSupports(s, r)
                    : s instanceof w.SupportsCondition
                    ? this.getCompletionsForSupportsCondition(s, r)
                    : s instanceof w.ExtendsReference &&
                      this.getCompletionsForExtendsReference(s, null, r);
                if (0 < r.items.length) return this.finalize(r);
              }
              return (
                ...
                if (s.browsers.onCodeComplete) {
                  ...
                  e
                    ? ((o = this.getCompletionRange(e.getProperty())),
                      (a = s.name + (c(e.colonPosition) ? "" : ": ")))
                    : ((o = this.getCompletionRange(null)),
                      (a = s.name + ": "));
                  var l = {
                    label: s.name,
                    documentation: v.getEntryDescription(s),
                    textEdit: k.TextEdit.replace(o, a),
                  ...
                  x.startsWith(s.name, "-") && (l.sortText = "x"),
                    t.items.push(l);
                }
              }
            return (
          ...
          (e.prototype.getCompletionsForDeclarationValue = function(e, t) {
            for (
              ...
              s = s.findChildAtOffset(this.offset, !1);
            if (
              (this.completionParticipants.forEach(function(e) {
              ...
              for (var o = 0, a = i.restrictions; o < a.length; o++) {
                switch (a[o]) {
                  case "color":
              ...
              for (
                var l = 0,
                  c = (function(e, r) {
                    var i = r.getFullPropertyName(),
                      t = new d();
                    function s(e) {
                      return (
                        (e instanceof w.Identifier ||
                          e instanceof w.NumericValue ||
                          e instanceof w.HexColorValue) &&
                          t.add(e.getText()),
                        !0
                      );
                    }
                    return (
                      e.accept(function(e) {
                        if (
                          e instanceof w.Declaration &&
                          e !== r &&
                          ((n = e.getFullPropertyName()), i === n)
                        ) {
                          var t = e.getValue();
                          t && t.accept(s);
                        }
                ...
                t.items.push({
                  label: h,
                  textEdit: k.TextEdit.replace(this.getCompletionRange(s), h),
                  kind: k.CompletionItemKind.Value
                });
              }
            return (
              this.getVariableProposals(s, t), this.getTermProposals(i, s, t), t
            );
          }),
          (e.prototype.getValueEnumProposals = function(e, t, n) {
            if (e.values)
              for (var r = 0, i = e.values; r < i.length; r++) {
                var s = i[r];
                if (v.isCommonValue(s)) {
                  var o = s.name,
                    a = void 0;
                  if (x.endsWith(o, ")")) {
                    var l = o.lastIndexOf("(");
                    -1 !== l && ((o = o.substr(0, l) + "($1)"), (a = S));
                  }
                  var c = {
                    label: s.name,
                    documentation: v.getEntryDescription(s),
                    textEdit: k.TextEdit.replace(this.getCompletionRange(t), o),
                    kind: k.CompletionItemKind.Value,
                    insertTextFormat: a
                  };
                  n.items.push(c);
          ...
          (e.prototype.getCSSWideKeywordProposals = function(e, t, n) {
            for (var r in v.cssWideKeywords)
              n.items.push({
                label: r,
                documentation: v.cssWideKeywords[r],
                textEdit: k.TextEdit.replace(this.getCompletionRange(t), r),
                kind: k.CompletionItemKind.Value
              });
            return n;
          }),
            ...
            for (
              var n = 0,
                r = this.getSymbolContext().findSymbolsAtOffset(
                  this.offset,
                  w.ReferenceType.Variable
                );
              n < r.length;
              n++
            ) {
              var i = r[n],
                s = x.startsWith(i.name, "--") ? "var(" + i.name + ")" : i.name,
                o = {
                  label: i.name,
                  documentation: i.value
                    ? x.getLimitedString(i.value)
                    : i.value,
                  textEdit: k.TextEdit.replace(this.getCompletionRange(e), s),
                  kind: k.CompletionItemKind.Variable,
                  sortText: "z"
                };
              if (i.node.type === w.NodeType.FunctionParameter) {
                var a = i.node.getParent();
                a.type === w.NodeType.MixinDeclaration &&
                  (o.detail = l(
                    "completion.argument",
                    "argument from '{0}'",
                    a.getName()
          ...
          (e.prototype.getVariableProposalsForCSSVarFunction = function(e) {
            for (
              ...
              e.items.push({
                label: i.name,
                documentation: i.value ? x.getLimitedString(i.value) : i.value,
                textEdit: k.TextEdit.replace(
          ...
          (e.prototype.getUnitProposals = function(e, t, n) {
            ...
            t &&
              t.parent &&
              t.parent.type === w.NodeType.Term &&
              (t = t.getParent());
            for (var s = 0, o = e.restrictions; s < o.length; s++) {
              var a = o[s],
                l = v.units[a];
              if (l)
                for (var c = 0, h = l; c < h.length; c++) {
                  ...
                  n.items.push({
                    label: d,
                    textEdit: k.TextEdit.replace(this.getCompletionRange(t), d),
                    kind: k.CompletionItemKind.Unit
                  });
                }
            }
            return n;
            ...
            if (e && e.offset <= this.offset) {
              var t =
                -1 !== e.end
                  ...
                  : this.position;
              return k.Range.create(this.textDocument.positionAt(e.offset), t);
            }
            return this.defaultReplaceRange;
          }),
          (e.prototype.getColorProposals = function(e, r, i) {
            for (var t in v.colors)
              i.items.push({
                label: t,
                documentation: v.colors[t],
                textEdit: k.TextEdit.replace(this.getCompletionRange(r), t),
                kind: k.CompletionItemKind.Color
              });
            for (var t in v.colorKeywords)
              i.items.push({
                label: t,
                documentation: v.colorKeywords[t],
                textEdit: k.TextEdit.replace(this.getCompletionRange(r), t),
                kind: k.CompletionItemKind.Value
              });
            var n = new d();
            this.styleSheet.acceptVisitor(new p(n));
            for (var s = 0, o = n.getEntries(); s < o.length; s++) {
              t = o[s];
              i.items.push({
                label: t,
                textEdit: k.TextEdit.replace(this.getCompletionRange(r), t),
            ...
            for (
              var a = function(e) {
                  ...
                  i.items.push({
                    ...
                    textEdit: k.TextEdit.replace(l.getCompletionRange(r), t),
                    insertTextFormat: S,
          ...
          (e.prototype.getPositionProposals = function(e, t, n) {
            for (var r in v.positionKeywords)
              n.items.push({
                label: r,
                documentation: v.positionKeywords[r],
                textEdit: k.TextEdit.replace(this.getCompletionRange(t), r),
                kind: k.CompletionItemKind.Value
              });
            return n;
          ...
          (e.prototype.getRepeatStyleProposals = function(e, t, n) {
            for (var r in v.repeatStyleKeywords)
              n.items.push({
                label: r,
                documentation: v.repeatStyleKeywords[r],
                textEdit: k.TextEdit.replace(this.getCompletionRange(t), r),
                kind: k.CompletionItemKind.Value
              });
            return n;
          ...
          (e.prototype.getLineStyleProposals = function(e, t, n) {
            for (var r in v.lineStyleKeywords)
              n.items.push({
                label: r,
                documentation: v.lineStyleKeywords[r],
                textEdit: k.TextEdit.replace(this.getCompletionRange(t), r),
                kind: k.CompletionItemKind.Value
              });
            return n;
          ...
          (e.prototype.getLineWidthProposals = function(e, t, n) {
            for (var r = 0, i = v.lineWidthKeywords; r < i.length; r++) {
              var s = i[r];
              n.items.push({
                label: s,
                textEdit: k.TextEdit.replace(this.getCompletionRange(t), s),
                kind: k.CompletionItemKind.Value
              });
            }
            return n;
          ...
          (e.prototype.getGeometryBoxProposals = function(e, t, n) {
            for (var r in v.geometryBoxKeywords)
              n.items.push({
                label: r,
                documentation: v.geometryBoxKeywords[r],
                textEdit: k.TextEdit.replace(this.getCompletionRange(t), r),
                kind: k.CompletionItemKind.Value
              });
            return n;
          ...
          (e.prototype.getBoxProposals = function(e, t, n) {
            for (var r in v.boxKeywords)
              n.items.push({
                label: r,
                documentation: v.boxKeywords[r],
                textEdit: k.TextEdit.replace(this.getCompletionRange(t), r),
                kind: k.CompletionItemKind.Value
              });
            return n;
          ...
          (e.prototype.getImageProposals = function(e, t, n) {
            for (var r in v.imageFunctions) {
              var i = F(r);
              n.items.push({
                label: r,
                documentation: v.imageFunctions[r],
                textEdit: k.TextEdit.replace(this.getCompletionRange(t), i),
                kind: k.CompletionItemKind.Function,
                insertTextFormat: r !== i ? S : void 0
              });
            }
            return n;
          }),
          (e.prototype.getTimingFunctionProposals = function(e, t, n) {
            for (var r in v.transitionTimingFunctions) {
              var i = F(r);
              n.items.push({
                label: r,
                documentation: v.transitionTimingFunctions[r],
                textEdit: k.TextEdit.replace(this.getCompletionRange(t), i),
                kind: k.CompletionItemKind.Function,
                insertTextFormat: r !== i ? S : void 0
              });
          ...
          (e.prototype.getBasicShapeProposals = function(e, t, n) {
            for (var r in v.basicShapeFunctions) {
              var i = F(r);
              n.items.push({
                label: r,
                documentation: v.basicShapeFunctions[r],
                textEdit: k.TextEdit.replace(this.getCompletionRange(t), i),
                kind: k.CompletionItemKind.Function,
                insertTextFormat: r !== i ? S : void 0
              });
            ...
            for (var t = 0, n = v.getAtDirectives(); t < n.length; t++) {
              ...
              0 < r.browsers.count &&
                e.items.push({
                  ...
                  documentation: v.getEntryDescription(r),
          ...
          (e.prototype.getCompletionsForRuleSet = function(e, t) {
            ...
            return n && n.endsWith("}") && this.offset >= n.end
              ...
              : (e.findParent(w.NodeType.Ruleset),
                this.getCompletionsForDeclarations(e.getDeclarations(), t));
          }),
          (e.prototype.getCompletionsForSelector = function(e, t, n) {
            var r = this,
              i = this.findInNodePath(
                w.NodeType.PseudoSelector,
                w.NodeType.IdentifierSelector,
                w.NodeType.ClassSelector,
                w.NodeType.ElementNameSelector
              );
            !i &&
            ...
            for (var s = 0, o = v.getPseudoClasses(); s < o.length; s++) {
              if ((m = o[s]).browsers.onCodeComplete) {
                var a = F(m.name),
                  l = {
                    label: m.name,
                    textEdit: k.TextEdit.replace(this.getCompletionRange(i), a),
                    documentation: v.getEntryDescription(m),
                    kind: k.CompletionItemKind.Function,
                    insertTextFormat: m.name !== a ? S : void 0
                  };
                x.startsWith(m.name, ":-") && (l.sortText = "x"),
                  n.items.push(l);
              }
            }
            for (var c = 0, h = v.getPseudoElements(); c < h.length; c++) {
            ...
            if (!t) {
              for (var d = 0, p = v.html5Tags; d < p.length; d++) {
                var m = p[d];
                n.items.push({
                  label: m,
                  textEdit: k.TextEdit.replace(this.getCompletionRange(i), m),
                  kind: k.CompletionItemKind.Keyword
                });
              }
              for (var u = 0, f = v.svgElements; u < f.length; u++) {
                m = f[u];
                n.items.push({
                  label: m,
                  textEdit: k.TextEdit.replace(this.getCompletionRange(i), m),
            ...
            if (
              (this.styleSheet.accept(function(e) {
                if (e.type === w.NodeType.SimpleSelector && 0 < e.length) {
          ...
          (e.prototype.getCompletionsForDeclarations = function(e, t) {
            ...
            if (n instanceof w.AbstractDeclaration) {
              var r = n;
              if (!c(r.colonPosition) || this.offset <= r.colonPosition)
                return this.getCompletionsForDeclarationProperty(r, t);
              if (c(r.semicolonPosition) && r.semicolonPosition < this.offset)
                return this.offset === r.semicolonPosition + 1
                  ? t
                  : this.getCompletionsForDeclarationProperty(null, t);
              if (r instanceof w.Declaration)
                return this.getCompletionsForDeclarationValue(r, t);
            } else
              n instanceof w.ExtendsReference &&
          ...
          (e.prototype.getCompletionsForExpression = function(e, t) {
            if (e.getParent() instanceof w.FunctionArgument)
              return (
                this.getCompletionsForFunctionArgument(
                  e.getParent(),
            ...
            var n = e.findParent(w.NodeType.Declaration);
            if (!n) return this.getTermProposals(null, null, t), t;
            var r = e.findChildAtOffset(this.offset, !0);
            return r
              ? r instanceof w.NumericValue || r instanceof w.Identifier
          ...
          (e.prototype.getCompletionsForMixinReference = function(e, t) {
            for (
              var n = 0,
                r = this.getSymbolContext().findSymbolsAtOffset(
                  this.offset,
                  w.ReferenceType.Mixin
                );
              n < r.length;
              n++
            ) {
              var i = r[n];
              i.node instanceof w.MixinDeclaration &&
                t.items.push(
                  this.makeTermProposal(i, i.node.getParameters(), null)
                );
            }
            return t;
          }),
            ...
            for (
              var r = 0,
                i = this.getSymbolContext().findSymbolsAtOffset(
                  this.offset,
                  w.ReferenceType.Function
                );
              r < i.length;
              r++
            ) {
              var s = i[r];
              s.node instanceof w.FunctionDeclaration &&
                n.items.push(
                  this.makeTermProposal(s, s.node.getParameters(), t)
                );
            }
            return n;
          }),
          (e.prototype.makeTermProposal = function(e, t, n) {
            ...
            var r = t.getChildren().map(function(e) {
                return e instanceof w.FunctionParameter
                  ? e.getName()
                  : e.getText();
              }),
              i =
            ...
            return {
              ...
              textEdit: k.TextEdit.replace(this.getCompletionRange(n), i),
              insertTextFormat: S,
              kind: k.CompletionItemKind.Function,
              sortText: "z"
            };
          ...
          (e.prototype.getCompletionsForSupports = function(e, t) {
            ...
            if (!n || this.offset <= n.offset) {
              ...
              return r instanceof w.SupportsCondition
                ? this.getCompletionsForSupportsCondition(r, t)
                : t;
            }
    ...
    var p = (function() {
      ...
      return (
        (e.prototype.visitNode = function(e) {
          return (
            (e instanceof w.HexColorValue ||
              (e instanceof w.Function && v.isColorConstructor(e))) &&
...
!(function(e) {
  if ("object" == typeof module && "object" == typeof module.exports) {
    ...
    "function" == typeof define &&
      define.amd &&
      define("vscode-css-languageservice/services/selectorPrinting", [
        "require",
        "exports",
        "../parser/cssNodes",
        "../parser/cssScanner"
  ...
  "use strict";
  Object.defineProperty(t, "__esModule", { value: !0 });
  var p = e("../parser/cssNodes"),
    r = e("../parser/cssScanner"),
    m = (function() {
      function o() {}
      return (
        (o.prototype.findAttribute = function(e) {
          if (this.attributes)
        ...
        (o.prototype.addAttr = function(e, t) {
        ...
        (o.prototype.clone = function(e) {
          ...
          if (this.attributes) {
            ...
            for (var n = 0, r = this.attributes; n < r.length; n++) {
              var i = r[n];
              t.addAttr(i.name, i.value);
            }
          }
          if (e && this.children) {
            t.children = [];
            for (var s = 0; s < this.children.length; s++)
              t.addChild(this.children[s].clone());
          }
          return t;
        }),
        (o.prototype.cloneWithParent = function() {
          var e = this.clone(!1);
          !this.parent ||
    ...
    n = (function() {
      ...
      return (
        ...
        (e.prototype.doPrint = function(e, t) {
          for (var n = 0, r = e; n < r.length; n++) {
            ...
            this.doPrintElement(i, t),
              i.children && this.doPrint(i.children, t + 1);
          }
        }),
        ...
        (e.prototype.doPrintElement = function(e, t) {
          ...
          if (e instanceof h || "…" === n) this.writeLine(t, n);
          else {
            var r = ["<"];
            if ((n ? r.push(n) : r.push("element"), e.attributes))
              for (var i = 0, s = e.attributes; i < s.length; i++) {
                var o = s[i];
                if ("name" !== o.name) {
                  r.push(" "), r.push(o.name);
                  var a = o.value;
                  a && (r.push("="), r.push(u.ensure(a, this.quote)));
                }
              }
  ...
  function d(e, t) {
    for (var n = new m(), r = 0, i = e.getChildren(); r < i.length; r++) {
      var s = i[r];
      switch (s.type) {
        case p.NodeType.SelectorCombinator:
          if (t) {
            var o = s.getText().split("&");
            if (1 === o.length) {
              n.addAttr("name", o[0]);
              break;
            }
            if (((n = t.cloneWithParent()), o[0])) n.findRoot().prepend(o[0]);
          ...
          break;
        case p.NodeType.SelectorPlaceholder:
          if ("@at-root" === s.getText()) return n;
        case p.NodeType.ElementNameSelector:
          var c = s.getText();
          n.addAttr("name", "*" === c ? "element" : f(c));
          break;
        case p.NodeType.ClassSelector:
          n.addAttr("class", f(s.getText().substring(1)));
          break;
        case p.NodeType.IdentifierSelector:
          n.addAttr("id", f(s.getText().substring(1)));
          break;
        case p.NodeType.MixinDeclaration:
          n.addAttr("class", s.getName());
          break;
        case p.NodeType.PseudoSelector:
          n.addAttr(f(s.getText()), "");
          break;
        case p.NodeType.AttributeSelector:
          var h = s.getExpression();
          if (h) {
            var d = void 0;
            if (h.getRight())
              switch (f(h.getOperator().getText())) {
                case "|=":
                  d = u.remove(f(h.getRight().getText())) + "-…";
                  break;
                case "^=":
                  d = u.remove(f(h.getRight().getText())) + "…";
                  break;
            ...
            n.addAttr(f(h.getLeft().getText()), d);
          }
      }
    }
    return n;
      ...
      (e.prototype.processSelector = function(e) {
        ...
        if (
          ...
          e.getChildren().some(function(e) {
            return (
              e.hasChildren() &&
              e.getChild(0).type === p.NodeType.SelectorCombinator
            );
          })
        ) {
        ...
        for (var r = 0, i = e.getChildren(); r < i.length; r++) {
          var s = i[r];
          if (s instanceof p.SimpleSelector) {
            if (this.prev instanceof p.SimpleSelector) {
              var o = new h("…");
              this.element.addChild(o), (this.element = o);
            } else
              this.prev &&
            ...
            this.prev &&
              this.prev.matches("~") &&
              (this.element.addChild(d(s)), this.element.addChild(new h("⋮")));
            var a = d(s, t),
              l = a.findRoot();
            this.element.addChild(l), (this.element = a);
          }
          (s instanceof p.SimpleSelector ||
            s.type === p.NodeType.SelectorCombinatorParent ||
            s.type === p.NodeType.SelectorCombinatorShadowPiercingDescendant ||
            s.type === p.NodeType.SelectorCombinatorSibling ||
            s.type === p.NodeType.SelectorCombinatorAllSiblings) &&
            (this.prev = s);
        }
      }),
      e
  ...
  function i(e) {
    ...
    var t = new c(),
      n = [];
    if (e.getParent() instanceof p.RuleSet)
      for (var r = e.getParent().getParent(); r && !l(r); ) {
        if (r instanceof p.RuleSet) {
          if (r.getSelectors().matches("@at-root")) break;
          n.push(r);
        }
        r = r.getParent();
      }
    for (var i = new a(t), s = n.length - 1; 0 <= s; s--) {
      var o = n[s].getSelectors().getChild(0);
      o && i.processSelector(o);
    }
    return i.processSelector(e), t;
  }
  t.selectorToElement = i;
}),
  (function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      var t = e(require, exports);
      ...
      "function" == typeof define &&
        define.amd &&
        define("vscode-css-languageservice/services/cssHover", [
          "require",
          "exports",
          "../parser/cssNodes",
          "./languageFacts",
      ...
      n = (function() {
        ...
        return (
          (e.prototype.doHover = function(t, e, n) {
            ...
            for (
              var i = t.offsetAt(e), s = p.getNodePath(n, i), o = 0;
              o < s.length;
              o++
            ) {
              var a = s[o];
              if (a instanceof p.Selector)
                return { contents: f.selectorToMarkedString(a), range: r(a) };
              if (a instanceof p.SimpleSelector)
                return {
                  contents: f.simpleSelectorToMarkedString(a),
                  range: r(a)
                };
              if (a instanceof p.Declaration) {
                var l = a.getFullPropertyName(),
                  c = m.getProperties()[l];
                if (c) {
                  var h = [];
                  c.description &&
                    h.push(u.MarkedString.fromPlainText(c.description));
                  var d = m.getBrowserLabel(c.browsers);
                  if ((d && h.push(u.MarkedString.fromPlainText(d)), h.length))
                    return { contents: h, range: r(a) };
                }
              }
            }
            return null;
  ...
  (function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define &&
        define.amd &&
        define("vscode-css-languageservice/services/cssNavigation", [
          "require",
          "exports",
          "../parser/cssNodes",
          "vscode-languageserver-types",
    ...
    "use strict";
    Object.defineProperty(t, "__esModule", { value: !0 });
    var c = e("../parser/cssNodes"),
      h = e("vscode-languageserver-types"),
      d = e("../parser/cssSymbolScope"),
      p = e("../services/languageFacts"),
      s = e("vscode-nls").loadMessageBundle(),
      n = (function() {
        function e() {}
        return (
          (e.prototype.findDefinition = function(e, t, n) {
            var r = new d.Symbols(n),
              i = e.offsetAt(t),
              s = c.getNodeAtOffset(n, i);
            if (!s) return null;
            var o = r.findSymbolFromNode(s);
            return o ? { uri: e.uri, range: m(o.node, e) } : null;
          }),
          ...
          (e.prototype.findDocumentHighlights = function(t, e, n) {
            ...
            if (
              !s ||
              s.type === c.NodeType.Stylesheet ||
              s.type === c.NodeType.Declarations
            )
              return r;
            var o = new d.Symbols(n),
              a = o.findSymbolFromNode(s),
              l = s.getText();
            return (
              n.accept(function(e) {
                if (a) {
                  if (o.matchesSymbol(e, a))
                    return r.push({ kind: u(e), range: m(e, t) }), !1;
                } else s.type === e.type && s.length === e.length && l === e.getText() && r.push({ kind: u(e), range: m(e, t) });
                return !0;
              }),
              r
            );
          }),
          (e.prototype.findDocumentSymbols = function(r, e) {
            var i = [];
            return (
              e.accept(function(e) {
                var t = {
                    name: null,
                    kind: h.SymbolKind.Class,
                    location: null
                  },
                  n = e;
                return (
                  e instanceof c.Selector
                    ? ((t.name = e.getText()),
                      (n = e.findParent(c.NodeType.Ruleset)))
                    : e instanceof c.VariableDeclaration
                    ? ((t.name = e.getName()), (t.kind = h.SymbolKind.Variable))
                    : e instanceof c.MixinDeclaration
                    ? ((t.name = e.getName()), (t.kind = h.SymbolKind.Method))
                    : e instanceof c.FunctionDeclaration
                    ? ((t.name = e.getName()), (t.kind = h.SymbolKind.Function))
                    ...
                    : e instanceof c.FontFace &&
                      (t.name = s("literal.fontface", "@font-face")),
                  t.name &&
                    ((t.location = h.Location.create(r.uri, m(n, r))),
                    i.push(t)),
                  !0
                );
              }),
          ...
          (e.prototype.getColorPresentations = function(e, t, n, r) {
            ...
            (i =
              1 === n.alpha
                ? "rgb(" + o + ", " + a + ", " + l + ")"
                : "rgba(" + o + ", " + a + ", " + l + ", " + n.alpha + ")"),
              s.push({ label: i, textEdit: h.TextEdit.replace(r, i) }),
              (i =
                1 === n.alpha
                  ? "#" + f(o) + f(a) + f(l)
                  : "#" + f(o) + f(a) + f(l) + f(Math.round(255 * n.alpha))),
              s.push({ label: i, textEdit: h.TextEdit.replace(r, i) });
            var c = p.hslFromColor(n);
            return (
              (i =
                1 === c.a
                  ? "hsl(" +
          ...
          (e.prototype.doRename = function(e, t, n, r) {
            var i,
              s = this.findDocumentHighlights(e, t, r).map(function(e) {
                return h.TextEdit.replace(e.range, n);
              });
            return { changes: ((i = {}), (i[e.uri] = s), i) };
          }),
          e
        );
      })();
    function m(e, t) {
      return h.Range.create(t.positionAt(e.offset), t.positionAt(e.end));
    }
    function u(e) {
      if (e.type === c.NodeType.Selector) return h.DocumentHighlightKind.Write;
      if (
        ...
        return h.DocumentHighlightKind.Write;
      if (e.parent)
      ...
      return h.DocumentHighlightKind.Read;
    }
    function f(e) {
      var t = e.toString(16);
  ...
  (function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define &&
        define.amd &&
        define("vscode-css-languageservice/services/lintRules", [
          "require",
          "exports",
          "../parser/cssNodes",
          "vscode-nls"
    ...
    (t.Rule = a),
      (t.Rules = {
        ...
        EmptyRuleSet: new a(
          "emptyRules",
          r("rule.emptyRuleSets", "Do not use empty rulesets"),
          i
        ),
        ...
        ZeroWithUnit: new a(
          "zeroUnits",
          r("rule.zeroWidthUnit", "No unit for zero needed"),
          o
        ),
        ...
        ArgsInColorFunction: new a(
          ...
          r("rule.colorFunction", "Invalid number of parameters"),
          s
        ),
        UnknownProperty: new a(
          "unknownProperties",
          r("rule.unknownProperty", "Unknown property."),
          i
        ),
        IEStarHack: new a(
          "ieHack",
  ...
  (function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define &&
        define.amd &&
        define("vscode-css-languageservice/services/cssCodeActions", [
          "require",
          "exports",
          "../parser/cssNodes",
          "./languageFacts",
      ...
      n = (function() {
        ...
        return (
          (e.prototype.doCodeActions = function(e, t, n, r) {
            var i = [];
            if (n.diagnostics)
              for (var s = 0, o = n.diagnostics; s < o.length; s++) {
                var a = o[s];
          ...
          (e.prototype.getFixesForUnknownProperty = function(e, t, n, r) {
            var i = t.getName(),
              s = [];
            for (var o in u.getProperties()) {
              var a = f.difference(i, o);
              a >= i.length / 2 && s.push({ property: o, score: a });
            }
            s.sort(function(e, t) {
              return t.score - e.score;
            });
            for (var l = 3, c = 0, h = s; c < h.length; c++) {
              var d = h[c].property,
                p = b("css.codeaction.rename", "Rename to '{0}'", d),
                m = g.TextEdit.replace(n.range, d);
              if (
                (r.push(
                  g.Command.create(
                    p,
          ...
          (e.prototype.appendFixesForMarker = function(e, t, n, r) {
            if (n.code === d.Rules.UnknownProperty.id)
              for (
                var i = e.offsetAt(n.range.start),
                  s = e.offsetAt(n.range.end),
                  o = h.getNodePath(t, i),
                  a = o.length - 1;
                0 <= a;
                a--
                ...
                var l = o[a];
                if (l instanceof h.Declaration) {
                  var c = l.getProperty();
                  if (c && c.offset === i && c.end === s)
                    return void this.getFixesForUnknownProperty(e, c, n, r);
                }
              }
          }),
          e
  ...
  (function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define &&
        define.amd &&
        define("vscode-css-languageservice/services/lint", [
          "require",
          "exports",
          "./languageFacts",
          "./lintRules",
    ...
    "use strict";
    Object.defineProperty(t, "__esModule", { value: !0 });
    var oe = e("./languageFacts"),
      ae = e("./lintRules"),
      le = e("../parser/cssNodes"),
      ce = e("vscode-nls").loadMessageBundle(),
      he = function(e, t) {
      ...
      n = (function() {
        function se(e, t) {
          (this.warnings = []),
            ...
            (this.keyframes = new de());
        }
        return (
          (se.entries = function(e, t, n, r) {
            var i = new se(t, n);
            return e.acceptVisitor(i), i.completeValidations(), i.getEntries(r);
          }),
          (se.prototype.fetch = function(e, t) {
          ...
          (se.prototype.fetchWithValue = function(e, t, n) {
            for (var r = [], i = 0, s = e; i < s.length; i++) {
              var o = s[i];
              if (o.name === t) {
                var a = o.node.getValue();
                a && this.findValueInExpression(a, n) && r.push(o);
              }
            }
            return r;
          }),
          (se.prototype.findValueInExpression = function(e, t) {
            var n = !1;
            return (
              e.accept(function(e) {
                return (
                  e.type === le.NodeType.Identifier &&
                    e.getText() === t &&
                    (n = !0),
                  !n
                );
          ...
          (se.prototype.getEntries = function(t) {
            return (
              void 0 === t && (t = le.Level.Warning | le.Level.Error),
              this.warnings.filter(function(e) {
                return 0 != (e.getLevel() & t);
              })
            );
          }),
          (se.prototype.addEntry = function(e, t, n) {
            var r = new le.Marker(e, t, this.settings.get(t), n);
            this.warnings.push(r);
          }),
          (se.prototype.getMissingNames = function(e, t) {
            e = e.slice(0);
            ...
            for (n = 0; n < e.length; n++) {
              ...
              s &&
                (i =
                  null === i
                    ? ce("namelist.single", "'{0}'", s)
                    : ce("namelist.concatenated", "{0}, '{1}'", i, s));
            }
            return i;
          }),
          (se.prototype.visitNode = function(e) {
            switch (e.type) {
              case le.NodeType.Keyframe:
                return this.visitKeyframe(e);
              case le.NodeType.FontFace:
                return this.visitFontFace(e);
              case le.NodeType.Ruleset:
                return this.visitRuleSet(e);
              case le.NodeType.SimpleSelector:
                return this.visitSimpleSelector(e);
              case le.NodeType.Function:
                return this.visitFunction(e);
              case le.NodeType.NumericValue:
                return this.visitNumericValue(e);
              case le.NodeType.Import:
                return this.visitImport(e);
              case le.NodeType.HexColorValue:
                return this.visitHexColorValue(e);
              case le.NodeType.Prio:
                return this.visitPrio(e);
            }
            return !0;
          }),
          (se.prototype.completeValidations = function() {
            this.validateKeyframes();
          }),
          (se.prototype.visitKeyframe = function(e) {
            var t = e.getKeyword(),
              n = t.getText();
            return (
          ...
          (se.prototype.validateKeyframes = function() {
            ...
            for (var t in this.keyframes.data) {
              ...
              if (r || 1 !== n.length) {
                ...
                if (i || r)
                  for (
                    var s = 0, o = this.keyframes.data[t].nodes;
                    s < o.length;
                    s++
                  ) {
                    var a = o[s];
                    if (r) {
                      ...
                      this.addEntry(
                        a,
                        ae.Rules.IncludeStandardPropertyWhenUsingVendorPrefix,
                        l
                      );
                    }
                    if (i) {
                      ...
                      this.addEntry(a, ae.Rules.AllVendorPrefixes, l);
                    }
                  }
              }
            }
          ...
          (se.prototype.visitSimpleSelector = function(e) {
            var t = this.documentText.charAt(e.offset);
            return (
              1 === e.length &&
                "*" === t &&
                this.addEntry(e, ae.Rules.UniversalSelector),
              "#" === t && this.addEntry(e, ae.Rules.AvoidIdSelector),
              !0
            );
          }),
          (se.prototype.visitImport = function(e) {
            return this.addEntry(e, ae.Rules.ImportStatemement), !0;
          }),
          (se.prototype.visitRuleSet = function(e) {
            var t = e.getDeclarations();
            if (!t) return !1;
            t.hasChildren() ||
              this.addEntry(e.getSelectors(), ae.Rules.EmptyRuleSet);
            for (var n = [], r = 0, i = t.getChildren(); r < i.length; r++) {
              if ((z = i[r]) instanceof le.Declaration) {
                var s = z;
                n.push(new he(s.getFullPropertyName().toLowerCase(), s));
              }
            }
            if (0 === this.fetch(n, "box-sizing").length) {
              var o = this.fetch(n, "width");
              if (0 < o.length) {
                for (
                  var a = !1,
                    l = 0,
                  ...
                  for (
                    var h = c[l], d = 0, p = this.fetch(n, h);
                    d < p.length;
                    d++
                  ) {
                    (A = (z = p[d]).node.getValue()) &&
                      !A.matches("none") &&
                      (this.addEntry(z.node, ae.Rules.BewareOfBoxModelSize),
                      (a = !0));
                  }
                if (a)
                  for (var m = 0, u = o; m < u.length; m++) {
                    var f = u[m];
                    this.addEntry(f.node, ae.Rules.BewareOfBoxModelSize);
                  }
              }
              var g = this.fetch(n, "height");
              if (0 < g.length) {
                a = !1;
                for (
                  var b = 0,
                  ...
                  h = y[b];
                  for (var w = 0, v = this.fetch(n, h); w < v.length; w++) {
                    (A = (z = v[w]).node.getValue()) &&
                      !A.matches("none") &&
                      (this.addEntry(z.node, ae.Rules.BewareOfBoxModelSize),
                      (a = !0));
                  }
                ...
                if (a)
                  for (var x = 0, k = g; x < k.length; x++) {
                    var S = k[x];
                    this.addEntry(S.node, ae.Rules.BewareOfBoxModelSize);
                  }
              }
            }
            var F = this.fetchWithValue(n, "display", "inline");
            if (0 < F.length)
              for (
                var C = 0,
                  T = [
                ...
                for (
                  var E = T[C], I = this.fetch(n, E), P = 0;
                  P < I.length;
                  P++
                ) {
                  var _ = I[P].node,
                    A = _.getValue();
                  ("float" !== E || (A && !A.matches("none"))) &&
                    this.addEntry(
                      _,
                      ae.Rules.PropertyIgnoredDueToDisplay,
                      ce(
            ...
            if (
              0 < (F = this.fetchWithValue(n, "display", "inline-block")).length
            )
              for (I = this.fetch(n, "float"), P = 0; P < I.length; P++) {
                var D = I[P].node;
                (A = D.getValue()) &&
                  !A.matches("none") &&
                  this.addEntry(
            ...
            if (0 < (F = this.fetchWithValue(n, "display", "block")).length)
              for (
                I = this.fetch(n, "vertical-align"), P = 0;
                P < I.length;
                P++
              )
                this.addEntry(
            ...
            var O = this.fetch(n, "float");
            for (P = 0; P < O.length; P++)
              this.addEntry(O[P].node, ae.Rules.AvoidFloat);
            for (var R = 0; R < n.length; R++) {
              var z;
              if ("background" !== (z = n[R]).name)
                if (
                  (A = z.node.getValue()) &&
                  "-" !== this.documentText.charAt(A.offset)
                ) {
                  var N = this.fetch(n, z.name);
                  if (1 < N.length)
                    for (var U = 0; U < N.length; U++) {
                      var M = N[U].node.getValue();
                      M &&
                        "-" !== this.documentText.charAt(M.offset) &&
                        N[U] !== z &&
                        this.addEntry(z.node, ae.Rules.DuplicateDeclarations);
                    }
                }
            }
            for (
              var L = new de(), j = !1, V = 0, B = t.getChildren();
              V < B.length;
              V++
            ) {
              var K = B[V];
              if (this.isCSSDeclaration(K)) {
                var q = (s = K).getFullPropertyName(),
                  $ = q.charAt(0);
                if ("-" === $) {
                  if ("-" !== q.charAt(1)) {
                    oe.isKnownProperty(q) ||
                      this.addEntry(
                        s.getProperty(),
                        ae.Rules.UnknownVendorSpecificProperty
                      );
                    var W = s.getNonPrefixedPropertyName();
                    L.add(W, q, s.getProperty());
                  }
                } else
                  ("*" !== $ && "_" !== $) ||
                    (this.addEntry(s.getProperty(), ae.Rules.IEStarHack),
                    (q = q.substr(1))),
                    oe.isKnownProperty(q) ||
                      this.addEntry(
                        s.getProperty(),
                        ae.Rules.UnknownProperty,
                        ce(
            ...
            if (!j)
              for (var G in L.data) {
                var H = L.data[G],
                  J = H.names,
                  X = oe.isKnownProperty(G) && -1 === J.indexOf(G);
                if (X || 1 !== J.length) {
                  for (
                    var Y = [], Q = ((R = 0), se.prefixes.length);
                    R < Q;
                    R++
                  ) {
                    var Z = se.prefixes[R];
                    oe.isKnownProperty(Z + G) && Y.push(Z + G);
                  }
                  var ee = this.getMissingNames(Y, J);
                  if (ee || X)
                    for (var te = 0, ne = H.nodes; te < ne.length; te++) {
                      var re = ne[te];
                      if (X) {
                        var ie = ce(
                      ...
                      if (ee) {
                        ...
                        this.addEntry(re, ae.Rules.AllVendorPrefixes, ie);
                      }
                    }
                }
              }
          ...
          (se.prototype.visitPrio = function(e) {
            return this.addEntry(e, ae.Rules.AvoidImportant), !0;
          }),
          (se.prototype.visitNumericValue = function(e) {
            var t = e.getValue();
            return (
              t.unit &&
                -1 !== oe.units.length.indexOf(t.unit.toLowerCase()) &&
                0 === parseFloat(t.value) &&
                t.unit &&
                this.addEntry(e, ae.Rules.ZeroWithUnit),
              !0
            );
          }),
          (se.prototype.visitFontFace = function(e) {
            var t = e.getDeclarations();
            if (t) {
              for (
                var n = !1, r = !1, i = !1, s = 0, o = t.getChildren();
                s < o.length;
                s++
              ) {
                var a = o[s];
              ...
              return (
                i ||
                  (n && r) ||
                  this.addEntry(e, ae.Rules.RequiredPropertiesForFontFace),
                !0
              );
            }
          }),
          (se.prototype.isCSSDeclaration = function(e) {
            if (e instanceof le.Declaration) {
          ...
          (se.prototype.visitHexColorValue = function(e) {
            var t = e.length;
            return (
              9 !== t &&
                7 !== t &&
                5 !== t &&
                4 !== t &&
                this.addEntry(e, ae.Rules.HexColorLength),
              !1
            );
          }),
          (se.prototype.visitFunction = function(e) {
            ...
            return (
              -1 !== n &&
                (e.getArguments().accept(function(e) {
                  return !(e instanceof le.BinaryExpression) || ((r += 1), !1);
                }),
                r !== n && this.addEntry(e, ae.Rules.ArgsInColorFunction)),
              !0
            );
          }),
          (se.prefixes = ["-ms-", "-moz-", "-o-", "-webkit-"]),
          se
        );
      })();
    t.LintVisitor = n;
  ...
  (function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define &&
        define.amd &&
        define("vscode-css-languageservice/services/cssValidation", [
          "require",
          "exports",
          "../parser/cssNodes",
          "vscode-languageserver-types",
    ...
    var i = e("../parser/cssNodes"),
      ...
      n = (function() {
        ...
        return (
          ...
          (e.prototype.doValidation = function(n, e, t) {
            if ((void 0 === t && (t = this.settings), t && !1 === t.validate))
              return [];
            var r = [];
            return (
              r.push.apply(r, i.ParseErrorCollector.entries(e)),
              r.push.apply(
                r,
                a.LintVisitor.entries(
                  e,
                  n,
                  new o.LintConfigurationSettings(t && t.lint)
                )
              ),
              r
                .filter(function(e) {
                  return e.getLevel() !== i.Level.Ignore;
                })
                .map(function(e) {
                  var t = s.Range.create(
                    n.positionAt(e.getOffset()),
                    n.positionAt(e.getOffset() + e.getLength())
                  );
                  return {
                    code: e.getRule().id,
                    source: n.languageId,
...
!(function(e) {
  if ("object" == typeof module && "object" == typeof module.exports) {
    ...
    "function" == typeof define &&
      define.amd &&
      define("vscode-css-languageservice/parser/scssScanner", [
        "require",
        "exports",
        "./cssScanner"
      ], e);
  ...
  var i = e("./cssScanner"),
    ...
    u = ">".charCodeAt(0),
    f = ".".charCodeAt(0),
    n = i.TokenType.CustomToken;
  (r.VariableName = n++),
    (r.InterpolationFunction = n++),
    (r.Default = n++),
    (r.EqualsOperator = n++),
    (r.NotEqualsOperator = n++),
    (r.GreaterEqualsOperator = n++),
    (r.SmallerEqualsOperator = n++),
    (r.Ellipsis = n++);
  var g = (function(n) {
    function e() {
    ...
    return (
      ...
      (e.prototype.scanNext = function(e) {
        if (this.stream.advanceIfChar(l)) {
          var t = ["$"];
          if (this.ident(t))
            return this.finishToken(e, r.VariableName, t.join(""));
          this.stream.goBackTo(e);
        }
        return this.stream.advanceIfChars([c, h])
          ? this.finishToken(e, r.InterpolationFunction)
          : this.stream.advanceIfChars([d, d])
          ? this.finishToken(e, r.EqualsOperator)
          : this.stream.advanceIfChars([p, d])
          ? this.finishToken(e, r.NotEqualsOperator)
          : this.stream.advanceIfChar(m)
          ? this.stream.advanceIfChar(d)
            ? this.finishToken(e, r.SmallerEqualsOperator)
            : this.finishToken(e, i.TokenType.Delim)
          : this.stream.advanceIfChar(u)
          ? this.stream.advanceIfChar(d)
            ? this.finishToken(e, r.GreaterEqualsOperator)
            : this.finishToken(e, i.TokenType.Delim)
          : this.stream.advanceIfChars([f, f, f])
          ? this.finishToken(e, r.Ellipsis)
  ...
  (function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define &&
        define.amd &&
        define("vscode-css-languageservice/parser/scssErrors", [
          "require",
          "exports",
          "vscode-nls"
        ], e);
...
!(function(e) {
  if ("object" == typeof module && "object" == typeof module.exports) {
    ...
    "function" == typeof define &&
      define.amd &&
      define("vscode-css-languageservice/parser/scssParser", [
        "require",
        "exports",
        "./scssScanner",
        "./cssScanner",
  ...
  var s = e("./scssScanner"),
    ...
    r = (function(r) {
      function e() {
        return r.call(this, new s.SCSSScanner()) || this;
      }
      return (
        __extends(e, r),
        (e.prototype._parseStylesheetStatement = function() {
          var e = r.prototype._parseStylesheetStatement.call(this);
          return (
            e ||
            (this.peek(o.TokenType.AtKeyword)
        ...
        (e.prototype._parseVariableDeclaration = function(e) {
          if ((void 0 === e && (e = []), !this.peek(s.VariableName)))
            return null;
          ...
          for (; this.accept(o.TokenType.Exclamation); ) {
            if (!this.peekRegExp(o.TokenType.Ident, /^(default|global)$/))
        ...
        (e.prototype._parseVariable = function() {
          if (!this.peek(s.VariableName)) return null;
        ...
        (e.prototype._parseIdent = function(e) {
          ...
          if (
            ...
            !this.peek(s.InterpolationFunction) &&
            !this.peekDelim("-")
          )
            return null;
          ...
          for (
            var r = !1,
              i = function() {
                return t.acceptDelim("-")
                  ? (!t.hasWhitespace() &&
                      t.acceptDelim("-") &&
                      (n.isCustomProperty = !0),
                    t.hasWhitespace() ? null : t._parseInterpolation())
                  : null;
              };
            (this.accept(o.TokenType.Ident) ||
              n.addChild(this._parseInterpolation() || this.try(i))) &&
            ((r = !0),
        ...
        (e.prototype._parseTerm = function() {
          var e = r.prototype._parseTerm.call(this);
          return (
            e ||
        ...
        (e.prototype._parseInterpolation = function() {
          if (this.peek(s.InterpolationFunction)) {
        ...
        (e.prototype._parseOperator = function() {
          if (
            this.peek(s.EqualsOperator) ||
            this.peek(s.NotEqualsOperator) ||
            this.peek(s.GreaterEqualsOperator) ||
            this.peek(s.SmallerEqualsOperator) ||
            this.peekDelim(">") ||
            this.peekDelim("<") ||
            this.peekIdent("and") ||
            this.peekIdent("or") ||
        ...
        (e.prototype._parseRuleSetDeclaration = function() {
          return this.peek(o.TokenType.AtKeyword)
            ...
            : this._parseVariableDeclaration() ||
                ...
                r.prototype._parseRuleSetDeclaration.call(this);
        }),
        (e.prototype._parseDeclaration = function(e) {
          var t = this.create(a.Declaration);
        ...
        (e.prototype._parseSimpleSelectorBody = function() {
          return (
            ...
            r.prototype._parseSimpleSelectorBody.call(this)
          );
        }),
        ...
        (e.prototype._internalParseIfStatement = function(e) {
          ...
          if ((this._parseBody(t, e), this.acceptKeyword("@else")))
            ...
            else if (this.peek(o.TokenType.CurlyL)) {
              ...
              ? this.acceptIdent("from")
                ? t.addChild(this._parseBinaryExpr())
                  ? this.acceptIdent("to") || this.acceptIdent("through")
                    ...
                    : this.finish(t, i.SCSSParseError.ThroughOrToExpected, [
                        o.TokenType.CurlyR
                      ])
                  : this.finish(t, l.ParseError.ExpressionExpected, [
                      o.TokenType.CurlyR
                    ])
                : this.finish(t, i.SCSSParseError.FromExpected, [
                    o.TokenType.CurlyR
                  ])
        ...
        (e.prototype._parseEachStatement = function(e) {
          ...
          return (
            ...
            this.acceptIdent("in")
              ...
              : this.finish(t, i.SCSSParseError.InExpected, [
                  o.TokenType.CurlyR
                ])
          );
        }),
        ...
        (e.prototype._parseFunctionArgument = function() {
          ...
          if (n)
            if (this.accept(o.TokenType.Colon)) e.setIdentifier(n);
            else {
              if (this.accept(s.Ellipsis)) return e.setValue(n), this.finish(e);
              this.restoreAtMark(t);
            }
        ...
        (e.prototype._parseURLArgument = function() {
          var e = this.mark(),
            t = r.prototype._parseURLArgument.call(this);
          if (!t || !this.peek(o.TokenType.ParenthesisR)) {
        ...
        (e.prototype._parseListElement = function() {
          var e = this.createNode(a.NodeType.ListEntry);
...
!(function(e) {
  if ("object" == typeof module && "object" == typeof module.exports) {
    ...
    "function" == typeof define &&
      define.amd &&
      define("vscode-css-languageservice/services/scssCompletion", [
        "require",
        "exports",
        "./cssCompletion",
        "../parser/cssNodes",
  ...
  var n = e("./cssCompletion"),
    ...
    i = (function(i) {
      ...
      return (
        __extends(s, i),
        (s.prototype.createReplaceFunction = function() {
          var n = 1;
          return function(e, t) {
            return (
              "\\" +
              ...
              n++ +
              ":" +
              (s.variableDefaults[t] || "") +
              "}"
            );
          };
        }),
        (s.prototype.createFunctionProposals = function(e, t, n, r) {
          for (var i = 0, s = e; i < s.length; i++) {
            var o = s[i],
              ...
              l = {
                label: o.func.substr(0, o.func.indexOf("(")),
                detail: o.func,
        ...
        (s.prototype.getCompletionsForSelector = function(e, t, n) {
          return (
            this.createFunctionProposals(s.selectorFuncs, void 0, !0, n),
            i.prototype.getCompletionsForSelector.call(this, e, t, n)
          );
        }),
        (s.prototype.getTermProposals = function(t, e, n) {
          var r = s.builtInFuncs;
          return (
            t &&
              (r = r.filter(function(e) {
                return !e.type || -1 !== t.restrictions.indexOf(e.type);
              })),
            this.createFunctionProposals(r, e, !0, n),
            i.prototype.getTermProposals.call(this, t, e, n)
          );
        }),
        (s.prototype.getColorProposals = function(e, t, n) {
          return (
            this.createFunctionProposals(s.colorProposals, t, !1, n),
            i.prototype.getColorProposals.call(this, e, t, n)
          );
        }),
        (s.prototype.getCompletionsForDeclarationProperty = function(e, t) {
          return (
            this.getCompletionsForSelector(null, !0, t),
            i.prototype.getCompletionsForDeclarationProperty.call(this, e, t)
          );
        }),
        (s.prototype.getCompletionsForExtendsReference = function(e, t, n) {
          for (
            var r = 0,
              i = this.getSymbolContext().findSymbolsAtOffset(
                this.offset,
        ...
        (s.colorProposals = [
          {
            func: "red($color)",
            desc: r("scss.builtin.red", "Gets the red component of a color.")
          },
          {
            func: "green($color)",
            desc: r(
          ...
          {
            func: "blue($color)",
            desc: r("scss.builtin.blue", "Gets the blue component of a color.")
          },
          {
            func: "mix($color, $color, [$weight])",
            desc: r("scss.builtin.mix", "Mixes two colors together.")
          },
          {
            func: "hue($color)",
            desc: r("scss.builtin.hue", "Gets the hue component of a color.")
          },
          {
          ...
          },
          {
            ...
            desc: r("scss.builtin.adjust-hue", "Changes the hue of a color.")
          },
          {
            func: "lighten($color, $amount)",
            desc: r("scss.builtin.lighten", "Makes a color lighter.")
          },
          {
            func: "darken($color, $amount)",
            desc: r("scss.builtin.darken", "Makes a color darker.")
          },
          {
            func: "saturate($color, $amount)",
            desc: r("scss.builtin.saturate", "Makes a color more saturated.")
          },
          {
            func: "desaturate($color, $amount)",
            desc: r("scss.builtin.desaturate", "Makes a color less saturated.")
          },
          {
            func: "grayscale($color)",
            desc: r("scss.builtin.grayscale", "Converts a color to grayscale.")
          },
          {
          ...
          {
            func: "invert($color)",
            desc: r("scss.builtin.invert", "Returns the inverse of a color.")
          },
          {
            func: "alpha($color)",
            desc: r(
          ...
          },
          {
            ...
            desc: r("scss.builtin.opacify", "Makes a color more opaque.")
          },
          {
            func: "fade-in($color, $amount)",
            desc: r("scss.builtin.fade-in", "Makes a color more opaque.")
          },
          {
          ...
          },
          {
            ...
            desc: r("scss.builtin.fade-out", "Makes a color more transparent.")
          },
          {
            func:
        ...
        (s.builtInFuncs = [
          {
            func: "unquote($string)",
            desc: r("scss.builtin.unquote", "Removes quotes from a string.")
          },
          {
            func: "quote($string)",
            desc: r("scss.builtin.quote", "Adds quotes to a string.")
          },
          {
          ...
          {
            func: "min($numbers)",
            desc: r("scss.builtin.min", "Finds the minimum of several numbers.")
          },
          {
            func: "max($numbers)",
            desc: r("scss.builtin.max", "Finds the maximum of several numbers.")
          },
          {
            func: "random([$limit])",
            desc: r("scss.builtin.random", "Returns a random number.")
          },
          {
            func: "length($list)",
            desc: r("scss.builtin.length", "Returns the length of a list.")
          },
          {
            func: "nth($list, $n)",
            desc: r("scss.builtin.nth", "Returns a specific item in a list.")
          },
          {
            func: "set-nth($list, $n, $value)",
            desc: r("scss.builtin.set-nth", "Replaces the nth item in a list.")
          },
          {
            func: "join($list1, $list2, [$separator])",
            desc: r("scss.builtin.join", "Joins together two lists into one.")
          },
          {
          ...
          {
            func: "type-of($value)",
            desc: r("scss.builtin.type-of", "Returns the type of a value.")
          },
          {
            func: "unit($number)",
            desc: r(
          ...
          {
            func: "call($name, $args…)",
            desc: r("scss.builtin.call", "Dynamically calls a Sass function.")
          }
        ]),
        s
      );
...
!(function(e) {
  if ("object" == typeof module && "object" == typeof module.exports) {
    ...
    "function" == typeof define &&
      define.amd &&
      define("vscode-css-languageservice/parser/lessScanner", [
        "require",
        "exports",
        "./cssScanner"
      ], e);
  ...
  var h = (function(n) {
    ...
    return (
      ...
      (e.prototype.comment = function() {
        return (
          !!n.prototype.comment.call(this) ||
          (!(this.inURL || !this.stream.advanceIfChars([i, i])) &&
            (this.stream.advanceWhileChar(function(e) {
              switch (e) {
                case s:
                case o:
...
!(function(e) {
  if ("object" == typeof module && "object" == typeof module.exports) {
    ...
    "function" == typeof define &&
      define.amd &&
      define("vscode-css-languageservice/parser/lessParser", [
        "require",
        "exports",
        "./lessScanner",
        "./cssScanner",
  ...
  var i = e("./lessScanner"),
    ...
    r = (function(r) {
      function e() {
        return r.call(this, new i.LESSScanner()) || this;
      }
      return (
        __extends(e, r),
        (e.prototype._parseStylesheetStatement = function() {
          return (
            ...
            r.prototype._parseStylesheetStatement.call(this) ||
            this._parseVariableDeclaration() ||
            this._parsePlugin()
          );
        }),
        ...
        (e.prototype._parsePlugin = function() {
          ...
          var e = this.createNode(a.NodeType.Plugin);
          return (
            this.consumeToken(),
            e.addChild(this._parseStringLiteral())
              ? this.accept(o.TokenType.SemiColon)
                ? this.finish(e)
                : this.finish(e, l.ParseError.SemiColonExpected)
              : this.finish(e, l.ParseError.StringLiteralExpected)
          );
        }),
        (e.prototype._parseMediaQuery = function(e) {
          var t = r.prototype._parseMediaQuery.call(this, e);
          if (!t) {
            var n = this.create(a.MediaQuery);
        ...
        (e.prototype._parseVariable = function() {
          if (!this.peekDelim("@") && !this.peek(o.TokenType.AtKeyword))
            return null;
          for (
            var e = this.create(a.Variable), t = this.mark();
            this.acceptDelim("@");
        ...
        (e.prototype._parseEscaped = function() {
          if (
            ...
            var e = this.createNode(a.NodeType.EscapedValue);
            return this.consumeToken(), this.finish(e);
          }
          if (this.peekDelim("~")) {
            e = this.createNode(a.NodeType.EscapedValue);
            return (
              this.consumeToken(),
              this.finish(
                e,
        ...
        (e.prototype._parseOperator = function() {
          ...
          return e || r.prototype._parseOperator.call(this);
        }),
        (e.prototype._parseGuardOperator = function() {
          ...
          if (this.peekDelim("=")) {
            e = this.createNode(a.NodeType.Operator);
            return this.consumeToken(), this.acceptDelim("<"), e;
          }
          if (this.peekDelim("<")) {
            e = this.createNode(a.NodeType.Operator);
        ...
        (e.prototype._parseKeyframeIdent = function() {
          return (
            this._parseIdent([a.ReferenceType.Keyframe]) ||
            this._parseVariable()
          );
        }),
        (e.prototype._parseKeyframeSelector = function() {
          return (
            this._parseDetachedRuleSetMixin() ||
            r.prototype._parseKeyframeSelector.call(this)
          );
        }),
        (e.prototype._parseSimpleSelectorBody = function() {
          return (
        ...
        (e.prototype._parseSelectorIdent = function() {
          ...
          var e = this.createNode(a.NodeType.SelectorInterpolation);
        ...
        (e.prototype._acceptInterpolatedIdent = function(e) {
          for (
            var t = this,
              ...
              r = function() {
                return t.acceptDelim("-")
                  ? (!t.hasWhitespace() && t.acceptDelim("-"),
                    t.hasWhitespace() ? null : t._parseInterpolation())
                  : null;
              };
            (this.accept(o.TokenType.Ident) ||
              e.addChild(this._parseInterpolation() || this.try(r))) &&
            ((n = !0),
            !this.hasWhitespace() && this.acceptDelim("-"),
            !this.hasWhitespace());
        ...
        (e.prototype._parseInterpolation = function() {
          var e = this.mark();
          if (this.peekDelim("@")) {
            var t = this.createNode(a.NodeType.Interpolation);
            return (
              this.consumeToken(),
              this.hasWhitespace() || !this.accept(o.TokenType.CurlyL)
                ...
                ? this.accept(o.TokenType.CurlyR)
                  ? this.finish(t)
                  : this.finish(t, l.ParseError.RightCurlyExpected)
                : this.finish(t, l.ParseError.IdentifierExpected)
            );
          }
          return null;
        }),
        (e.prototype._tryParseMixinDeclaration = function() {
          var e = this.mark(),
            t = this.create(a.MixinDeclaration);
          if (
          ...
          if (t.getParameters().addChild(this._parseMixinParameter()))
            for (
              ...
              t.getParameters().addChild(this._parseMixinParameter()) ||
                this.markError(
                  t,
                  l.ParseError.IdentifierExpected,
                  [],
                  [o.TokenType.ParenthesisR]
                );
          return this.accept(o.TokenType.ParenthesisR)
        ...
        (e.prototype._parseMixinDeclarationIdentifier = function() {
          ...
          if (this.peekDelim("#") || this.peekDelim(".")) {
            ...
            (e = this.create(a.Identifier)), this.consumeToken();
          }
          return (e.referenceTypes = [a.ReferenceType.Mixin]), this.finish(e);
        }),
        (e.prototype._parsePseudo = function() {
          if (!this.peek(o.TokenType.Colon)) return null;
          var e = this.mark(),
            t = this.create(a.ExtendsReference);
          return (
            this.consumeToken(),
            this.acceptIdent("extend")
              ? this._completeExtends(t)
              : (this.restoreAtMark(e), r.prototype._parsePseudo.call(this))
          );
        }),
        ...
        (e.prototype._parseDetachedRuleSetMixin = function() {
          if (!this.peek(o.TokenType.AtKeyword)) return null;
          var e = this.mark(),
            t = this.create(a.MixinReference);
        ...
        (e.prototype._tryParseMixinReference = function(e) {
          void 0 === e && (e = !1);
          for (
            var t = this.mark(),
              n = this.create(a.MixinReference),
              r = this._parseMixinDeclarationIdentifier();
            r;
          ...
          if (!this.hasWhitespace() && this.accept(o.TokenType.ParenthesisL)) {
            if (
              ((s = !0), n.getArguments().addChild(this._parseMixinArgument()))
            )
              for (
                ;
                (this.accept(o.TokenType.Comma) ||
                ...
                if (!n.getArguments().addChild(this._parseMixinArgument()))
                  return this.finish(n, l.ParseError.ExpressionExpected);
            if (!this.accept(o.TokenType.ParenthesisR))
              return this.finish(n, l.ParseError.RightParenthesisExpected);
            r.referenceTypes = [a.ReferenceType.Mixin];
          } else
            r.referenceTypes = [a.ReferenceType.Mixin, a.ReferenceType.Rule];
          return (
            n.addChild(this._parsePrio()),
            s ||
            this.peek(o.TokenType.SemiColon) ||
        ...
        (e.prototype._parseMixinParameter = function() {
          ...
          if (this.peekKeyword("@rest")) {
            var t = this.create(a.Node);
            return (
              this.consumeToken(),
              this.accept(i.Ellipsis)
                ? (e.setIdentifier(this.finish(t)), this.finish(e))
                : this.finish(
                    e,
                    l.ParseError.DotExpected,
                    [],
                    [o.TokenType.Comma, o.TokenType.ParenthesisR]
                  )
            );
          }
          if (this.peek(i.Ellipsis)) {
            var n = this.create(a.Node);
            return (
              this.consumeToken(),
          ...
          return (
            e.setIdentifier(this._parseVariable()) &&
              (this.accept(o.TokenType.Colon), (r = !0)),
            e.setDefaultValue(this._parseExpr(!0)) || r ? this.finish(e) : null
          );
        }),
        (e.prototype._parseGuard = function() {
          if (!this.peekIdent("when")) return null;
          var e = this.create(a.LessGuard);
          if (
            (this.consumeToken(),
            (e.isNegated = this.acceptIdent("not")),
            !e.getConditions().addChild(this._parseGuardCondition()))
          )
            return this.finish(e, l.ParseError.ConditionExpected);
        ...
        (e.prototype._parseGuardCondition = function() {
          if (!this.peek(o.TokenType.ParenthesisL)) return null;
          var e = this.create(a.GuardCondition);
          return (
            this.consumeToken(),
            e.addChild(this._parseExpr()),
            this.accept(o.TokenType.ParenthesisR)
...
!(function(e) {
  if ("object" == typeof module && "object" == typeof module.exports) {
    ...
    "function" == typeof define &&
      define.amd &&
      define("vscode-css-languageservice/services/lessCompletion", [
        "require",
        "exports",
        "./cssCompletion",
        "vscode-languageserver-types",
        ...
        (s.builtInProposals = [
          {
            ...
            description: r("less.builtin.escape", "URL encodes a string")
          },
          {
            name: "e",
            example: "e(@string);",
            description: r("less.builtin.e", "escape string content")
          },
          {
            name: "replace",
            example: "replace(@string, @pattern, @replacement[, @flags]);",
            description: r("less.builtin.replace", "string replace")
          },
          {
            name: "unit",
          ...
          },
          {
            ...
            description: r("less.builtin.color", "parses a string to a color"),
            type: "color"
          },
          {
            name: "convert",
          ...
          {
            name: "abs",
            description: r("less.builtin.abs", "absolute value of a number"),
            example: "abs(number);"
          },
          {
            name: "acos",
          ...
          },
          {
            name: "ceil",
            example: "ceil(@number);",
            description: r("less.builtin.ceil", "rounds up to an integer")
          },
          {
            name: "cos",
            description: r("less.builtin.cos", "cosine function"),
            example: "cos(number);"
          },
          {
            name: "floor",
            description: r("less.builtin.floor", "rounds down to an integer"),
          ...
          {
            name: "sin",
            description: r("less.builtin.sin", "sine function"),
            example: "sin(number);"
          },
          {
            name: "tan",
            description: r("less.builtin.tan", "tangent function"),
            example: "tan(number);"
          },
          {
            name: "atan",
          ...
          {
            name: "pi",
            description: r("less.builtin.pi", "returns pi"),
            example: "pi();"
          },
          {
            name: "pow",
        ...
        (s.colorProposals = [
          {
            name: "argb",
            example: "argb(@color);",
            description: r("less.builtin.argb", "creates a #AARRGGBB")
          },
          {
            name: "hsl",
            example: "hsl(@hue, @saturation, @lightness);",
            description: r("less.builtin.hsl", "creates a color")
          },
          {
            name: "hsla",
            example: "hsla(@hue, @saturation, @lightness, @alpha);",
            description: r("less.builtin.hsla", "creates a color")
          },
          {
            name: "hsv",
            example: "hsv(@hue, @saturation, @value);",
            description: r("less.builtin.hsv", "creates a color")
          },
          {
            name: "hsva",
            example: "hsva(@hue, @saturation, @value, @alpha);",
            description: r("less.builtin.hsva", "creates a color")
          },
          {
            name: "hue",
            example: "hue(@color);",
  ...
  (function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      ...
      "function" == typeof define &&
        define.amd &&
        define("vscode-css-languageservice/cssLanguageService", [
          "require",
          "exports",
          "vscode-languageserver-types",
          "./parser/cssParser",
    ...
    (t.getCSSLanguageService = function() {
      return m(
        new r.Parser(),
        new i.CSSCompletion(),
        new s.CSSHover(),
      ...
      (t.getSCSSLanguageService = function() {
        return m(
          new c.SCSSParser(),
          new h.SCSSCompletion(),
          new s.CSSHover(),
          new o.CSSNavigation(),
          new a.CSSCodeActions(),
          new l.CSSValidation()
      ...
      (t.getLESSLanguageService = function() {
        return m(
          new d.LESSParser(),
          new p.LESSCompletion(),
          new s.CSSHover(),
          new o.CSSNavigation(),
          new a.CSSCodeActions(),
          new l.CSSValidation()
  ...
  define("vscode-css-languageservice", [
    "vscode-css-languageservice/cssLanguageService"
  ], function(e) {
    return e;
  }),
  define("vs/language/css/cssWorker", [
    "require",
    "exports",
        ...
        return (
          (e.prototype.doValidation = function(e) {
            ...
            if (t) {
              var n = this._languageService.parseStylesheet(t),
                r = this._languageService.doValidation(t, n);
              return o.as(r);
            }
            return o.as([]);
          }),
          ...
          (e.prototype.doCodeActions = function(e, t, n) {
            var r = this._getTextDocument(e),
              ...
              s = this._languageService.doCodeActions(r, t, n, i);
            return o.as(s);
          }),
          (e.prototype.findColorSymbols = function(e) {
            var t = this._getTextDocument(e),
              n = this._languageService.parseStylesheet(t),
              r = this._languageService.findColorSymbols(t, n);
            return o.as(r);
          }),
          (e.prototype.doRename = function(e, t, n) {
            var r = this._getTextDocument(e),
              i = this._languageService.parseStylesheet(r),
              s = this._languageService.doRename(r, t, n, i);
            return o.as(s);
          }),
