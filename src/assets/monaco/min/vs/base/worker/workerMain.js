        ...
        a = (function() {
          ...
          return (
            ...
            (e.prototype.WALKTRACE = function(
              ...
              do {
                (b = P + e) === A || (b < L && c[b - 1] < c[b + 1])
                  ? ((m = (h = c[b + 1]) - P - i),
                    h < N && S.MarkNextChange(),
                    (N = h),
            ...
            (e.prototype.ComputeRecursionPoint = function(e, t, r, i, s, u, a) {
              ...
              for (f = 1; f <= _ / 2 + 1; f++) {
                ...
                if (
                  ...
                  !this.ContinueProcessingPredicate(N, this.OriginalSequence, w)
                )
                  return (
                    (a[0] = !0),
                    (s[0] = N),
                ...
                for (
                  ...
                  for (
                    ...
                    l--, c--;
                  if (((y[L] = l), A && Math.abs(L - b) <= f && l <= v[L]))
                    return (
                      (s[0] = l),
                      (u[0] = c),
                      P >= v[L] && f <= 1448
  ...
  r(e[6], t([1, 0, 5]), function(e, t, n) {
    ...
    r(e[16], t([1, 0, 15]), function(e, t, n) {
      ...
      (t.removeAnsiEscapeCodes = function(e) {
        return (
          e && (e = (e = (e = e.replace(E, "")).replace(S, "")).replace(A, "")),
          e
        );
      }),
      ...
      t(
        ...
        function(e, t, n, r, i, o) {
          ...
          function u(e, t) {
            var n;
            (n =
              t && "object" == typeof t && "function" == typeof t.then ? I : x),
              (e._value = t),
              e._setState(n);
          }
            ...
            j = n.Class.define(
              ...
              },
              {
                cancel: function() {},
                  ...
                  (n instanceof Error && n.message === P) || H._doneHandler(n);
                },
                then: function(e, t) {
                  if (!t) return this;
                  var n,
          ...
          return (
            Object.defineProperties(H, i.createEventProperties(L)),
            (H._doneHandler = function(e) {
              t._setImmediate(function() {
                throw e;
              });
            }),
            { PromiseStateMachine: q, Promise: H, state_created: w }
          );
        }
      ),
      t(
        ...
        return (
          ...
          (e.prototype.queue = function(e) {
            ...
            return new r.TPromise(function(n, r, i) {
              t.outstandingPromises.push({ factory: e, c: n, e: r, p: i }),
                t.consume();
            });
          }),
      ...
      var m = (function(e) {
        ...
        _ = (function() {
          ...
          return (
            ...
            (t.prototype.textualSuggest = function(e, t, n, i) {
              var o = this._getModel(e);
              if (o) {
                for (
                  var s = [],
