...
define("vs/editor/editor.main.nls.zh-cn", {
  ...
  "vs/editor/common/view/editorColorRegistry": [
    ...
    "编辑器中提示波浪线的前景色。",
    "编辑器中提示波浪线的边框颜色。",
    "概览标尺中高亮范围的标记颜色。颜色必须透明，使其不会挡住下方的其他元素。",
    "概述错误的标尺标记颜色。",
    "概述警告的标尺标记颜色。",
    "概述信息的标尺标记颜色。"
  ],
  ...
  "vs/editor/contrib/caretOperations/transpose": ["转置字母"],
  ...
  "vs/editor/contrib/contextmenu/contextmenu": ["显示编辑器上下文菜单"],
  ...
  "vs/editor/contrib/hover/hover": ["显示悬停"],
  "vs/editor/contrib/hover/modesContentHover": ["正在加载..."],
  ...
  "vs/editor/contrib/parameterHints/parameterHints": ["触发参数提示"],
  ...
  "vs/editor/contrib/referenceSearch/peekViewWidget": ["关闭"],
  "vs/editor/contrib/referenceSearch/referenceSearch": [
    " – {0} 个引用",
    "查找所有引用"
  ],
  "vs/editor/contrib/referenceSearch/referencesController": ["正在加载..."],
  ...
  "vs/editor/contrib/smartSelect/smartSelect": ["扩大选择", "缩小选择"],
  ...
  "vs/platform/list/browser/listService": [
    ...
    '映射为 "Ctrl" (Windows 和 Linux) 或 "Command" (macOS)',
    '映射为 "Alt" (Windows 和 Linux) 或 "Option" (macOS)',
    '在通过鼠标多选树和列表条目时使用的修改键 (例如资资源管理器、打开的编辑器和源代码管理视图)。"ctrlCmd" 会映射为 "Ctrl" (Windows 和 Linux) 或 "Command" (macOS)。“在侧边打开”功能所需的鼠标动作 (若可用) 将会相应调整，不与多选修改键冲突。',
    "在鼠标单击时打开项目。",
    "在鼠标双击时打开项目。",
  ...
  "vs/platform/theme/common/colorRegistry": [
    ...
    "插入的文本的轮廓颜色。",
    "被删除文本的轮廓颜色。",
    "内嵌的合并冲突处理器中当前版本区域头部的背景色。颜色必须透明，使其不会挡住下方的其他元素。",
    "内嵌的合并冲突处理器中当前版本区域内容的背景色。颜色必须透明，使其不会挡住下方的其他元素。",
    "内嵌的合并冲突处理器中传入版本区域头部的背景色。颜色必须透明，使其不会挡住下方的其他元素。",
    "内嵌的合并冲突处理器中传入版本区域内容的背景色。颜色必须透明，使其不会挡住下方的其他元素。",
    "内嵌的合并冲突处理器中共同上级区域头部的背景色。颜色必须透明，使其不会挡住下方的其他元素。",
    "内嵌的合并冲突处理器中共同上级区域内容的背景色。颜色必须透明，使其不会挡住下方的其他元素。",
    "内联合并冲突中标头和分割线的边框颜色。",
