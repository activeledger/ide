...
define("vs/editor/editor.main.nls.es", {
  ...
  "vs/editor/common/config/commonEditorConfig": [
    ...
    "Controla la visualización de números de línea. Los valores posibles son 'on', 'off', 'relative' e 'interval'.",
    ...
    "Controla el lado dónde rendir el minimapa. Los valores posibles son 'derecha' e 'izquierda'",
  ...
  "vs/platform/theme/common/colorRegistry": [
    ...
    "Colorea el rango limitando la búsqueda. El color no debe ser opaco para no ocultar las decoraciones subyacentes.",
    "Color de borde de la coincidencia de búsqueda actual.",
    "Color de borde de otra búsqueda que coincide.",
    "Color de borde del rango limitando a la búsqueda. El color no debe ser opaco para no ocultar las decoraciones subyacentes.",
    ...
    "Fondo de contenido de ancester común en conflictos de fusión en línea. El color no debe ser opaco para no ocultar las decoraciones subyacentes.",
