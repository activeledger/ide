...
define("vs/editor/editor.main.nls.it", {
  ...
  "vs/editor/common/config/commonEditorConfig": [
    ...
    "Controlla la visualizzazione dei numeri di riga. I valori possibili sono 'on', 'off', 'relativi' ed 'intervallo'.",
    ...
    "Definisce il lato in cui viene mostrata la mini mappa. I possibili valori sono 'destra' o 'sinistra'",
  ...
  "vs/editor/common/view/editorColorRegistry": [
    ...
    "Colore del marcatore righello panoramica per evidenziazione intervalli. Il colore non deve essere opaco per non nascondere decorazioni sottostanti.",
  ...
  "vs/editor/contrib/caretOperations/transpose": ["Trasponi lettere"],
  ...
  "vs/editor/contrib/hover/hover": ["Visualizza passaggio del mouse"],
  "vs/editor/contrib/hover/modesContentHover": ["Caricamento..."],
  ...
  "vs/editor/contrib/referenceSearch/peekViewWidget": ["Chiudi"],
  "vs/editor/contrib/referenceSearch/referenceSearch": [
    " - Riferimenti di {0}",
    "Trova tutti i riferimenti"
  ],
  "vs/editor/contrib/referenceSearch/referencesController": ["Caricamento..."],
  ...
  "vs/platform/list/browser/listService": [
    ...
    "Apre elementi facendo un singolo clic col mouse.",
    "Apre elementi facendo doppio clic col mouse.",
  ...
  "vs/platform/markers/common/markers": ["Errore", "Avviso", "Informazioni"],
  "vs/platform/theme/common/colorRegistry": [
    ...
    "Colore di primo piano di Elenco/Struttura ad albero per gli elementi non validi, ad esempio una radice non risolta in Esplora.",
    ...
    "Colore dell'intervallo limite della ricerca. Il colore non deve essere opaco per evitare di nascondere le decorazioni sottostanti.",
    "Colore del bordo della corrispondenza della ricerca corrente.",
    "Colore del bordo delle altre corrispondenze della ricerca.",
    "Colore del bordo dell'intervallo che delimita la ricerca. Il colore non deve essere opaco per non nascondere decorazioni sottostanti.",
    ...
    "Sfondo intestazione corrente in conflitti di merge in linea. Il colore non deve essere opaco per evitare di nascondere le decorazioni sottostanti.",
    "Sfondo contenuto corrente in conflitti di merge in linea. Il colore non deve essere opaco per evitare di nascondere le decorazioni sottostanti.",
    "Sfondo intestazione modifica in ingresso in conflitti di merge in linea. Il colore non deve essere opaco per evitare di nascondere le decorazioni sottostanti.",
    "Sfondo contenuto modifica in ingresso in conflitti di merge in linea. Il colore non deve essere opaco per evitare di nascondere le decorazioni sottostanti.",
    "Sfondo dell'intestazione dell'antenato comune nei conflitti di merge in linea. Il colore non deve essere opaco per evitare di nascondere le decorazioni sottostanti.",
    "Sfondo del contenuto dell'antenato comune nei conflitti di merge in linea. Il colore non deve essere opaco per evitare di nascondere le decorazioni sottostanti.",
