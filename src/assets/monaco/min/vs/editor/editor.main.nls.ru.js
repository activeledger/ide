...
define("vs/editor/editor.main.nls.ru", {
  ...
  "vs/editor/common/config/commonEditorConfig": [
    ...
    "Управляет отображением номеров строк. Возможные значения: 'on', 'off', 'relative' и 'interval'.",
    ...
    'Определяет, с какой стороны будет отображаться мини-карта. Возможные значения: "right" и "left"',
  ...
  "vs/editor/common/view/editorColorRegistry": [
    ...
    "Цвет метки линейки в окне просмотра для выделений диапазонов. Цвет должен быть прозрачным, чтобы не перекрывать основные знаки отличия.",
  ...
  "vs/editor/contrib/caretOperations/transpose": ["Транспортировать буквы"],
  ...
  "vs/editor/contrib/hover/hover": ["Показать при наведении"],
  "vs/editor/contrib/hover/modesContentHover": ["Идет загрузка..."],
  ...
  "vs/editor/contrib/parameterHints/parameterHintsWidget": ["{0}, подсказка"],
  ...
  "vs/editor/contrib/referenceSearch/peekViewWidget": ["Закрыть"],
  ...
  "vs/platform/list/browser/listService": [
    ...
    "Открывает элемент одним щелчком мыши.",
    "Открывает элемент двойным щелчком мыши.",
  ...
  "vs/platform/theme/common/colorRegistry": [
    ...
    "Выделите диапазон для ограничения поиска. Цвет должен быть прозрачным, чтобы не перекрывать основные знаки отличия.",
    ...
    "Фон текущего заголовка при конфликтах встроеного слияния. Цвет должен быть прозрачным, чтобы не перекрывать основные знаки отличия.",
    "Фон текущего содержания при конфликтах встроеного слияния. Цвет должен быть прозрачным, чтобы не перекрывать основные знаки отличия.",
    "Фон измененного заголовка при конфликтах встроенного слияния. Цвет должен быть прозрачным, чтобы не перекрывать основные знаки отличия.",
    "Фон измененного содержания при конфликтах встроенного слияния. Цвет должен быть прозрачным, чтобы не перекрывать основные знаки отличия.",
    "Фон заголовка для общего предшественника при конфликтах внутреннего слияния. Цвет должен быть прозрачным, чтобы не перекрывать основные знаки отличия.",
    "Фон содержания общего предшественника при конфликтах внутреннего слияния. Цвет должен быть прозрачным, чтобы не перекрывать основные знаки отличия.",
